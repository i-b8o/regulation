...
class Regulation {
  ...
  static const String abbreviation = "ПОТЭУ";
  ...
  static const List<Chapter> chapters = <Chapter>[
    Chapter(id: 1, name: "Общие положения", num: "I", paragraphs: [
      Paragraph(
          id: 100017,
          num: 0,
          isHTML: false,
    ...
    Chapter(
        id: 2,
        name:
            "Требования к работникам, допускаемым к выполнению работв электроустановках",
        num: "II",
        paragraphs: [
          Paragraph(
              id: 100028,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Приведенные в <a href='101687'>приложении N 1</a> к Правилам требования к персоналу в отношении электробезопасности являются минимальными и решением руководителя организации могут быть дополнены.",
              chapterID: 0),
          Paragraph(
              id: 100034,
              num: 6,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Рекомендуемый образец удостоверения, выдаваемого должностным лицам, осуществляющим контроль и надзор за соблюдением требований безопасности при эксплуатации электроустановок, и специалистам по охране труда, предусмотрен <a href='101819'>приложением N 3</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100043,
              num: 15,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Работникам, указанным в <a href='100031'>пункте 2.3</a> Правил и прошедшим проверку знаний требований Правил и других требований безопасности, предъявляемых к организации и выполнению работ в электроустановках, выдаются удостоверения о проверке знаний правил работы в электроустановках, рекомендуемые образцы которых предусмотрены <a href='101756'>приложениями N 2</a>, <a href='101819'>3</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100045,
              num: 17,
              ...
              paragraphClass: "-",
              content:
                  "Результаты проверки знаний по охране труда в организациях электроэнергетики оформляются протоколом проверки знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101846'>приложением N 4</a> к Правилам, и учитываются в журнале учета проверки знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101873'>приложением N 5</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100046,
              num: 18,
              ...
              paragraphClass: "-",
              content:
                  "Результаты проверки знаний по охране труда для организаций, приобретающих электрическую энергию для собственных бытовых и производственных нужд, фиксируются в журнале учета проверки знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101895'>приложением N 6</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100047,
              num: 19,
              ...
              paragraphClass: "-",
              content:
                  "2.5 Работники, обладающие правом проведения специальных работ, должны иметь об этом запись в удостоверении о проверке знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101756'>приложением N 2</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100048,
              num: 20,
              isHTML: false,
              paragraphClass: "-",
              content: "К специальным работам в электроустановках относятся:",
              chapterID: 0),
          Paragraph(
              id: 100049,
              num: 21,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Право на проведение специальных работ подтверждается записью в <a href='101813'>поле</a> 'Свидетельство на право проведения специальных работ' удостоверения о проверке знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен в <a href='101756'>приложении N 2</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100058,
              num: 30,
              ...
              paragraphClass: "-",
              content:
                  "2.9. Удостоверение о проверке знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101756'>приложением N 2</a> к Правилам, является документом, удостоверяющим право предъявителя на самостоятельную работу в указанной должности.",
              chapterID: 0),
          Paragraph(
              id: 100059,
              num: 31,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "В <a href='101768'>графе</a> 'Допущен в качестве' рекомендуется указывать категорию персонала: административно-технический, диспетчерский, оперативный, оперативно-ремонтный, ремонтный персонал;",
              chapterID: 0),
          Paragraph(
              id: 100061,
              num: 33,
              ...
              paragraphClass: "-",
              content:
                  "<a href='101770'>графу</a> 'к работам в электроустановках напряжением' рекомендуется заполнять после проверки знаний для работников, допущенных в соответствии с ОРД организации (обособленного подразделения), к выполнению работ или организации безопасного выполнения работ в электроустановках с указанием класса напряжения (до 1000 В, до и выше 1000 В).",
              chapterID: 0),
          Paragraph(
              id: 100062,
              num: 34,
              ...
              paragraphClass: "-",
              content:
                  "Общую оценку результатов проверки знаний рекомендуется указывать в <a href='101777'>поле</a> 'Результаты проверки знаний нормативных документов'. <a href='101777'>Поле</a> рекомендуется не заполнять в случае проведения работнику организации электроэнергетики внеочередной проверки знаний по одному из следующих разделов: устройство и техническая эксплуатация, охрана труда, пожарная безопасность.",
              chapterID: 0),
          Paragraph(
              id: 100063,
              num: 35,
              ...
              paragraphClass: "-",
              content:
                  "Поля '<a href='101785'>Результаты</a> проверки знаний нормативных документов по устройству и технической эксплуатации', '<a href='101792'>Результаты</a> проверки знаний нормативных документов по охране труда', '<a href='101800'>Результаты</a> проверки знаний нормативных документов по пожарной безопасности' рекомендуется заполнять для работников организаций электроэнергетики и они содержат оценки результатов проверки знаний нормативных документов по разделам: устройство и техническая эксплуатация, охрана труда, пожарная безопасность.",
              chapterID: 0),
          Paragraph(
              id: 100064,
              num: 36,
              ...
              paragraphClass: "-",
              content:
                  "<a href='101807'>Поле</a> 'Результаты проверки знаний нормативных документов по промышленной безопасности и других специальных правил' рекомендуется заполнять для работников, которым по их должностным обязанностям и характеру производственной деятельности требуется проверка знаний правил промышленной безопасности и других специальных правил.",
              chapterID: 0),
          Paragraph(
              id: 100065,
              num: 37,
              ...
              paragraphClass: "-",
              content:
                  "<a href='101813'>Поле</a> 'Свидетельство на право проведения специальных работ' рекомендуется заполнять для работников, допускаемых к проведению специальных работ (работы на высоте, работы под напряжением, работы под наведенным напряжением, проведение испытаний).",
              chapterID: 0),
          Paragraph(
              id: 100066,
              num: 38,
              ...
              paragraphClass: "-",
              content:
                  "2.10. Для работников, допущенных к работам под напряжением на токоведущих частях, при заполнении <a href='101815'>графы</a> 'наименование работ' в поле 'Свидетельство на право проведения специальных работ' следует руководствоваться следующей таблицей:",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 39,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='170.05pt;'><col width='283.45pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst100067'></a>Индекс</p></td><td><p class='align_center no-indent'><a id='dst100068'></a>Напряжение электроустановок, кВ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100069'></a>И1</p></td><td><p class='align_center no-indent'><a id='dst100070'></a>ВЛИ до 1</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100071'></a>И2</p></td><td><p class='align_center no-indent'><a id='dst100072'></a>Остальные электроустановки: до 1</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100073'></a>И3</p></td><td><p class='align_center no-indent'><a id='dst100074'></a>Электроустановки 6 - 20</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100075'></a>И4</p></td><td><p class='align_center no-indent'><a id='dst100076'></a>35</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100077'></a>И5</p></td><td><p class='align_center no-indent'><a id='dst100078'></a>110</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100079'></a>И6</p></td><td><p class='align_center no-indent'><a id='dst100080'></a>220</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100081'></a>И7</p></td><td><p class='align_center no-indent'><a id='dst100082'></a>330</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100083'></a>И8</p></td><td><p class='align_center no-indent'><a id='dst100084'></a>500</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100085'></a>И9</p></td><td><p class='align_center no-indent'><a id='dst100086'></a>750</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 100087,
              num: 40,
    ...
    Chapter(
        id: 3,
        name:
            "Охрана труда при оперативном обслуживаниии осмотрах электроустановок",
        num: "III",
        paragraphs: [
          Paragraph(
              id: 100089,
    ...
    Chapter(
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              num: 1,
              isHTML: false,
              paragraphClass: "align_center",
              content:
                  "Допустимые расстояния до токоведущих частейэлектроустановок, находящихся под напряжением",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='128.15pt;'><col width='155.4pt;'><col width='164.65pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst100096'></a>Напряжение электроустановок, кВ</p></td><td><p class='align_center no-indent'><a id='dst100097'></a>Расстояние от работников и применяемых ими инструментов и приспособлений, от временных ограждений, м</p></td><td><p class='align_center no-indent'><a id='dst100098'></a>Расстояния от механизмов и подъемных сооружений в рабочем и транспортном положении от стропов, грузозахватных приспособлений и грузов, м</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100099'></a>ВЛ до 1</p></td><td><p class='align_center no-indent'><a id='dst100100'></a>0,6</p></td><td><p class='align_center no-indent'><a id='dst100101'></a>1,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100102'></a>Остальные электроустановки:</p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100103'></a>до 1</p></td><td><p class='align_center no-indent'><a id='dst100104'></a>не нормируется</p><p class='align_center no-indent'>(без прикосновения)</p></td><td><p class='align_center no-indent'><a id='dst100105'></a>1,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100106'></a>1 - 35</p></td><td><p class='align_center no-indent'><a id='dst100107'></a>0,6</p></td><td><p class='align_center no-indent'><a id='dst100108'></a>1,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100109'></a>60 (постоянный ток) - 110</p></td><td><p class='align_center no-indent'><a id='dst100110'></a>1,0</p></td><td><p class='align_center no-indent'><a id='dst100111'></a>1,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100112'></a>150</p></td><td><p class='align_center no-indent'><a id='dst100113'></a>1,5</p></td><td><p class='align_center no-indent'><a id='dst100114'></a>2,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100115'></a>220</p></td><td><p class='align_center no-indent'><a id='dst100116'></a>2,0</p></td><td><p class='align_center no-indent'><a id='dst100117'></a>2,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100118'></a>330</p></td><td><p class='align_center no-indent'><a id='dst100119'></a>2,5</p></td><td><p class='align_center no-indent'><a id='dst100120'></a>3,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100121'></a>400 (постоянный ток) - 500</p></td><td><p class='align_center no-indent'><a id='dst100122'></a>3,5</p></td><td><p class='align_center no-indent'><a id='dst100123'></a>4,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100124'></a>750</p></td><td><p class='align_center no-indent'><a id='dst100125'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst100126'></a>6,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100127'></a>1150</p></td><td><p class='align_center no-indent'><a id='dst100128'></a>8,0</p></td><td><p class='align_center no-indent'><a id='dst100129'></a>10,0</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 100130,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Осмотр воздушных линий электропередачи (устройств для передачи электроэнергии по проводам, расположенным на открытом воздухе, прикрепленным с помощью изоляторов и арматуры к опорам или кронштейнам и стойкам на инженерных сооружениях (мостах, путепроводах) (далее - ВЛ) должен выполняться в соответствии с требованиями <a href='100446'>пунктов 7.15</a>, <a href='101234'>38.73</a>, <a href='101235'>38.74</a>, <a href='101239'>38.75</a> Правил. За начало и конец ВЛ принимаются линейные порталы или линейные вводы электроустановки, служащей для приема и распределения электроэнергии и содержащей коммутационные аппараты, сборные и соединительные шины, вспомогательные устройства (компрессорные, аккумуляторные), а также устройства защиты, автоматики и измерительные приборы (далее - распределительные устройства, РУ), а для ответвлений - ответвительная опора и линейный портал или линейный ввод распределительного устройства.",
              chapterID: 0),
          Paragraph(
              id: 100134,
              num: 7,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При осмотре электроустановок напряжением выше 1000 В не допускается входить в помещения, камеры, не оборудованные ограждениями или барьерами, препятствующими приближению к токоведущим частям на расстояния менее указанных в <a href='100095'>таблице N 1</a>, предусмотренной <a href='100093'>пунктом 3.3</a> Правил (далее - таблица N 1). Не допускается проникать за ограждения и барьеры электроустановок.",
              chapterID: 0),
          Paragraph(
              id: 100138,
              num: 11,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Под напряжением и под нагрузкой допускается заменять:",
              chapterID: 0),
          Paragraph(
              id: 100145,
              num: 18,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "предохранители трансформаторов напряжения;",
              chapterID: 0),
          Paragraph(
              id: 100147,
              num: 20,
              isHTML: false,
              paragraphClass: "-",
              content: "предохранители пробочного типа.",
              chapterID: 0),
          Paragraph(
              id: 100148,
              num: 21,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Ключи от электроустановок должны выдаваться:",
              chapterID: 0),
          Paragraph(
              id: 100156,
              num: 29,
    ...
    Chapter(
        id: 5,
        name:
            "Охрана труда при производстве работв действующих электроустановках",
        num: "IV",
        paragraphs: [
          Paragraph(
              id: 100162,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "по заданию на производство работы, определяющему содержание, место работы, время ее начала и окончания, условия безопасного проведения, состав бригады и работников, ответственных за безопасное выполнение работы (далее - наряд-допуск), рекомендуемый образец которого предусмотрен <a href='101911'>приложением N 7</a> к Правилам;",
              chapterID: 0),
          Paragraph(
              id: 100164,
              num: 2,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При работах на токоведущих частях электроустановок напряжением до и выше 1000 В допускается приближение люльки подъемных сооружений с изолирующим звеном к находящимся под напряжением неогражденным или неизолированным токоведущим частям на расстояния менее указанных в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 100179,
              num: 17,
              ...
              paragraphClass: "-",
              content:
                  "4.7. Не допускается в электроустановках работать в согнутом положении, если при выпрямлении расстояние до токоведущих частей будет менее расстояния, указанного в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 100180,
              num: 18,
    ...
    Chapter(
        id: 6,
        name:
            "Организационные мероприятия по обеспечению безопасногопроведения работ в электроустановках",
        num: "V",
        paragraphs: [
          Paragraph(
              id: 100198,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "выдача разрешения на подготовку рабочего места и на допуск к работе с учетом требований <a href='100280'>пункта 5.14</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100201,
              num: 3,
              isHTML: false,
              paragraphClass: "-",
              content: "допуск к работе; надзор во время работы;",
              chapterID: 0),
          Paragraph(
              id: 100202,
              num: 4,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "выдающий разрешение на подготовку рабочего места и на допуск с учетом требований <a href='100280'>пункта 5.14</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100206,
              num: 8,
              isHTML: false,
              paragraphClass: "-",
              content: "ответственный руководитель работ;",
              chapterID: 0),
          Paragraph(
              id: 100207,
              num: 9,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Ответственными руководителями работ в электроустановках напряжением выше 1000 В назначаются работники из числа административно-технического персонала, имеющие группу V и группу IV по электробезопасности - в электроустановках напряжением до 1000 В. В тех случаях, когда отдельные работы (этапы работы) необходимо выполнять под надзором и управлением ответственного руководителя работ, работник, выдающий наряд-допуск, должен сделать запись об этом в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска, рекомендуемый образец которого предусмотрен <a href='101911'>приложением N 7</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100223,
              num: 25,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "с использованием механизмов и подъемных сооружений;",
              chapterID: 0),
          Paragraph(
              id: 100226,
              num: 28,
              ...
              paragraphClass: "-",
              content:
                  "в ОРУ/ЗРУ с отключением электрооборудования, за исключением работ в электроустановках, где напряжение снято со всех токоведущих частей (<a href='100309'>пункт 6.8</a> Правил);",
              chapterID: 0),
          Paragraph(
              id: 100227,
              num: 29,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "по подключению вновь сооруженной ВЛ;",
              chapterID: 0),
          Paragraph(
              id: 100231,
              num: 33,
              isHTML: false,
              paragraphClass: "-",
              content: "по изменению схем присоединений проводов и тросов ВЛ;",
              chapterID: 0),
          Paragraph(
              id: 100232,
              num: 34,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "по пофазному ремонту ВЛ;",
              chapterID: 0),
          Paragraph(
              id: 100235,
              num: 37,
              isHTML: false,
              paragraphClass: "-",
              content: "под наведенным напряжением;",
              chapterID: 0),
          Paragraph(
              id: 100236,
              num: 38,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Допускающие должны назначаться из числа оперативного персонала, за исключением допуска на ВЛ, КЛ, КВЛ при соблюдении условий, перечисленных в <a href='100260'>пункте 5.13</a> Правил. В электроустановках напряжением выше 1000 В допускающий должен иметь группу IV по электробезопасности, а в электроустановках до 1000 В - группу III по электробезопасности.",
              chapterID: 0),
          Paragraph(
              id: 100242,
              num: 44,
              isHTML: false,
              paragraphClass: "-",
              content: "5.9. Производитель работ отвечает:",
              chapterID: 0),
          Paragraph(
              id: 100243,
              num: 45,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Производитель работ, выполняемых по распоряжению, должен иметь группу III по электробезопасности при работе во всех электроустановках, кроме случаев, указанных в <a href='100425'>пунктах 7.7</a>, <a href='100768'>25.5</a>, <a href='101303'>39.21</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100251,
              num: 53,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Ответственным за безопасность, связанную с технологией работы, является работник, возглавляющий бригаду, который входит в ее состав и должен постоянно находиться на рабочем месте. Его фамилия указывается в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 100258,
              num: 60,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "5.12. ОРД организации (обособленного подразделения) должно быть оформлено предоставление прав работникам, выдающим наряд-допуск, распоряжение, выдающим разрешение на подготовку рабочего места и допуск (с учетом требований <a href='100280'>пункта 5.14</a> Правил) допускающему, ответственному руководителю работ (наблюдающему), а также права проведения единоличного осмотра электроустановок.",
              chapterID: 0),
          Paragraph(
              id: 100260,
              num: 62,
              ...
              paragraphClass: "-",
              content:
                  "5.13. Работникам, ответственным за безопасное ведение работ, разрешается выполнять одну из дополнительных обязанностей в соответствии с <a href='100267'>таблицей N 2</a>.",
              chapterID: 0),
          Paragraph(
              id: 100261,
              num: 63,
    ...
    Chapter(
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='193.6pt;'><col width='254.6pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst100268'></a>Ответственный работник</p></td><td><p class='align_center no-indent'><a id='dst100269'></a>Дополнительные обязанности</p></td></tr><tr><td><p class='no-indent'><a id='dst100270'></a>Выдающий наряд-допуск, отдающий распоряжение</p></td><td><p class='no-indent'><a id='dst100271'></a>Ответственный руководитель работ, производитель работ, допускающий (в электроустановках, не имеющих местного оперативного персонала</p></td></tr><tr><td><p class='no-indent'><a id='dst100272'></a>Выдающий разрешение на подготовку рабочего места и на допуск к работе</p></td><td><p class='no-indent'><a id='dst100273'></a>Выдающий наряд-допуск, отдающий распоряжение, ответственный руководитель работ, допускающий (в электроустановках, не имеющих местного оперативного персонала)</p></td></tr><tr><td><p class='no-indent'><a id='dst100274'></a>Ответственный руководитель работ</p></td><td><p class='no-indent'><a id='dst100275'></a>Производитель работ, допускающий (в электроустановках, не имеющих местного оперативного персонала)</p></td></tr><tr><td><p class='no-indent'><a id='dst100276'></a>Производитель работ из числа оперативного и оперативно-ремонтного персонала</p></td><td><p class='no-indent'><a id='dst100277'></a>Допускающий (в электроустановках с простой наглядной схемой)</p></td></tr><tr><td><p class='no-indent'><a id='dst100278'></a>Производитель работ, имеющий группу IV по электробезопасности</p></td><td><p class='no-indent'><a id='dst100279'></a>Допускающий (в случаях, предусмотренных в <a href='/document/cons_doc_LAW_372952/7511d177b57021cd56695a4e10d4826fb708fd13/#dst101471'>пункте 42.5</a> Правил)</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 100280,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Член бригады, руководимой производителем работ, при выполнении работ должен иметь группу III по электробезопасности, за исключением выполнения работ на ВЛ в соответствии с <a href='101149'>пунктом 38.23</a> Правил, выполнять которые должен член бригады, имеющий группу IV по электробезопасности.",
              chapterID: 0),
          Paragraph(
              id: 100283,
              num: 6,
    ...
    Chapter(
        id: 8,
        name:
            "Организация работ в электроустановкахс оформлением наряда-допуска",
        num: "VI",
        paragraphs: [
          Paragraph(
              id: 100286,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.7. Наряд-допуск разрешается выдавать на одно или несколько рабочих мест электрической цепи (оборудование и шины) одного назначения, наименования и напряжения, присоединенной к шинам РУ, генератора, щита, сборки и находящихся в пределах электростанции, подстанции (далее - присоединение) с учетом требований, указанных в <a href='100309'>пунктах 6.8</a>, <a href='100311'>6.9</a>, <a href='100314'>6.11</a>, <a href='100315'>6.12</a>, <a href='100325'>6.14</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100307,
              num: 21,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.13. При проведении работ согласно <a href='100309'>пунктам 6.8</a>, <a href='100311'>6.9</a>, <a href='100314'>6.11</a>, <a href='100315'>6.12</a> Правил рабочие места должны быть подготовлены до допуска бригады на первое рабочее место.",
              chapterID: 0),
          Paragraph(
              id: 100322,
              num: 36,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Выходить из РУ производитель работ с линейной бригадой имеет право самостоятельно, а отдельные члены бригады - в порядке, предусмотренном <a href='100521'>пунктом 11.3</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100332,
              num: 46,
              ...
              paragraphClass: "-",
              content:
                  "6.16. Работы на концевых муфтах и заделках КЛ, расположенных в РУ, должны выполняться по нарядам-допускам, выдаваемым персоналом, обслуживающим РУ. Если РУ и КЛ принадлежат разным организациям, то эти работы проводятся в соответствии с требованиями, изложенными в <a href='101604'>главе XLVI</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100333,
              num: 47,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "при работах на ВЛ в местах их пересечения;",
              chapterID: 0),
          Paragraph(
              id: 100339,
              num: 53,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.25. При заполнении лицевой стороны наряда-допуска в <a href='101914'>строке</a> 'Подразделение' рекомендуется указывать структурное подразделение (цех, служба, район, участок) организации, в электроустановках которой предстоят работы.",
              chapterID: 0),
          Paragraph(
              id: 100355,
              num: 69,
              ...
              paragraphClass: "-",
              content:
                  "В случаях, когда ответственный руководитель работ не назначается, в <a href='101916'>строке</a> 'Ответственному руководителю работ' рекомендуется делать запись 'не назначается'.",
              chapterID: 0),
          Paragraph(
              id: 100356,
              num: 70,
              ...
              paragraphClass: "-",
              content:
                  "В <a href='101917'>строке</a> 'допускающему' рекомендуется указывать фамилия допускающего, назначаемого из числа оперативного персонала, или производителя (ответственного руководителя) работ из числа ремонтного персонала, совмещающего обязанности допускающего. При выполнении работ в электроустановках, где допускающим является работник из числа оперативного персонала, находящегося на дежурстве, рекомендуется в <a href='101917'>строке</a> записывать 'оперативному персоналу' без указания фамилии.",
              chapterID: 0),
          Paragraph(
              id: 100357,
              num: 71,
              ...
              paragraphClass: "-",
              content:
                  "В <a href='101919'>строке</a> 'с членами бригады' рекомендуется перечислять членов бригады, выполняющих работы в электроустановке. При выполнении работ с применением автомобилей, механизмов и самоходных кранов рекомендуется указывать, кто из членов бригады является водителем, крановщиком, стропальщиком, а также тип механизма или самоходного крана, на котором он работает.",
              chapterID: 0),
          Paragraph(
              id: 100358,
              num: 72,
              ...
              paragraphClass: "-",
              content:
                  "В <a href='101920'>строках</a> 'поручается' рекомендуется:",
              chapterID: 0),
          Paragraph(
              id: 100359,
              num: 73,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.26. В <a href='101923'>таблице</a> 'Мероприятия по подготовке рабочих мест' рекомендуется указывать:",
              chapterID: 0),
          Paragraph(
              id: 100362,
              num: 76,
              isHTML: false,
              paragraphClass: "-",
              content: "при работе в электроустановках РУ и на КЛ:",
              chapterID: 0),
          Paragraph(
              id: 100363,
              num: 77,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101927'>графе 1</a> - наименование электроустановок, в которых необходимо провести операции с коммутационными аппаратами и установить заземления;",
              chapterID: 0),
          Paragraph(
              id: 100364,
              num: 78,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101928'>графе 2</a> - наименования (обозначения) коммутационных аппаратов, присоединений, оборудования, с которыми проводятся операции, и места, где должны быть установлены заземления.",
              chapterID: 0),
          Paragraph(
              id: 100365,
              num: 79,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101927'>графе 1</a> - наименования линий, цепей, проводов, записанные в <a href='101920'>строке</a> 'поручается' наряда-допуска, а также наименования других ВЛ или цепей, подлежащих отключению и заземлению в связи с выполнением работ на ремонтируемой ВЛ или цепи (например, ВЛ, пересекающихся с ремонтируемой линией или проходящих вблизи нее, других цепей многоцепной ВЛ и т.п.);",
              chapterID: 0),
          Paragraph(
              id: 100368,
              num: 82,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101928'>графе 2</a> - для ВЛ, отключаемых и заземляемых допускающим из числа оперативного персонала, - наименование коммутационных аппаратов в РУ и на самой ВЛ, с которыми проводятся операции, и номера опор, на которых должны быть установлены заземления.",
              chapterID: 0),
          Paragraph(
              id: 100369,
              num: 83,
              ...
              paragraphClass: "-",
              content:
                  "В этой же <a href='101928'>графе</a> указываются номера опор или пролеты, где производитель работ должен установить заземления на провода и тросы на рабочем месте в соответствии с <a href='100665'>пунктами 22.2</a>, <a href='100669'>22.6</a>, <a href='100673'>22.8</a>, <a href='100678'>22.10</a>, <a href='100682'>22.12</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100370,
              num: 84,
              ...
              paragraphClass: "-",
              content:
                  "Если места установки заземлений при выдаче наряда-допуска определить нельзя или работа будет проводиться с перестановкой заземлений, в <a href='101928'>графе</a> рекомендуется указывать 'Заземлить на рабочих местах';",
              chapterID: 0),
          Paragraph(
              id: 100371,
              num: 85,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101928'>графе 2</a> - места, где производитель работ должен установить заземления на ВЛ, пересекающихся с ремонтируемой или проходящей вблизи нее. Если эти ВЛ эксплуатируются другой организацией (службой), в <a href='101930'>строке</a> наряда-допуска 'Отдельные указания' должно быть указано о необходимости проверки заземлений, устанавливаемых персоналом этой организации (службы).",
              chapterID: 0),
          Paragraph(
              id: 100372,
              num: 86,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.28. В <a href='101930'>строке</a> 'Отдельные указания' рекомендуется указывать:",
              chapterID: 0),
          Paragraph(
              id: 100375,
              num: 89,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "этапы работы и отдельные операции, которые должны выполняться под непрерывным управлением ответственного руководителя работ, согласно <a href='100221'>пункту 5.7</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100377,
              num: 91,
              ...
              paragraphClass: "-",
              content:
                  "в случае оформления наряда-допуска наблюдающему - фамилия и инициалы ответственного работника, возглавляющего бригаду, согласно <a href='100251'>пункту 5.10</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100378,
              num: 92,
              ...
              paragraphClass: "-",
              content:
                  "разрешение ответственному руководителю и производителю работ выполнять перевод работников на другое рабочее место, согласно <a href='100530'>пункту 12.1</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100379,
              num: 93,
              ...
              paragraphClass: "-",
              content:
                  "разрешение производителю работ (наблюдающему) осуществлять повторный допуск, согласно <a href='100542'>пункту 13.3</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100380,
              num: 94,
              ...
              paragraphClass: "-",
              content:
                  "разрешение включить электроустановку или ее часть (отдельные коммутационные аппараты) без разрешения или распоряжения оперативного персонала, согласно <a href='100555'>пункту 15.2</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100381,
              num: 95,
              ...
              paragraphClass: "-",
              content:
                  "разрешение на временное снятие заземлений согласно <a href='100653'>пунктам 21.5</a> и <a href='101283'>39.12</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100382,
              num: 96,
              ...
              paragraphClass: "-",
              content:
                  "разрешение производителю работ оперировать коммутационными аппаратами согласно <a href='101482'>пункту 43.2</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100383,
              num: 97,
              ...
              paragraphClass: "-",
              content:
                  "ответственные работники за безопасное производство работ кранами (подъемниками) согласно <a href='101575'>пункту 45.3</a> Правил);",
              chapterID: 0),
          Paragraph(
              id: 100384,
              num: 98,
              ...
              paragraphClass: "-",
              content:
                  "указание о том, что ремонтируемая линия находится в зоне наведенного напряжения от другой ВЛ, согласно <a href='101177'>пункту 38.43</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100385,
              num: 99,
              ...
              paragraphClass: "-",
              content:
                  "дополнительные требования, предъявляемые к мерам безопасности при работах в зоне влияния электрического и магнитного поля согласно <a href='100761'>пункту 24.18</a> Правил;",
              chapterID: 0),
          Paragraph(
              id: 100386,
              num: 100,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "разрешение производителю работ осуществлять опробование коммутационных аппаратов согласно <a href='100888'>пункту 28.7</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100389,
              num: 103,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.29. В строках <a href='101931'>'Наряд-допуск выдал'</a> и <a href='101932'>'Наряд-допуск продлил'</a> работнику, выдающему наряд-допуск, рекомендуется указывать дату и время его подписания.",
              chapterID: 0),
          Paragraph(
              id: 100391,
              num: 105,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "6.30. В <a href='101942'>таблице</a> 'Разрешение на подготовку рабочих мест и на допуск к выполнению работ', заполняемой при получении разрешения на подготовку рабочего места и первичного допуска к работе, рекомендуется указывать:",
              chapterID: 0),
          Paragraph(
              id: 100393,
              num: 107,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101946'>графе 1</a> - работники, подготавливающие рабочие места, и допускающий указывают должности и фамилии работников, выдавших разрешение на подготовку рабочих мест и на допуск к выполнению работ (далее - разрешение). При передаче разрешений лично в <a href='101946'>графе 1</a> расписываются работники, выдающие разрешение, с указанием своей должности;",
              chapterID: 0),
          Paragraph(
              id: 100394,
              num: 108,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101947'>графе 2</a> - дата и время выдачи разрешения;",
              chapterID: 0),
          Paragraph(
              id: 100395,
              num: 109,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='101948'>графе 3</a> расписываются работники, получившие разрешение. При подготовке рабочих мест несколькими работниками или работниками различных цехов в <a href='101948'>графе 3</a> расписываются все, кто готовил рабочие места.",
              chapterID: 0),
          Paragraph(
              id: 100396,
              num: 110,
              ...
              paragraphClass: "-",
              content:
                  "Если разрешения запрашиваются не одновременно, то в <a href='101942'>таблице</a> 'Разрешение на подготовку рабочих мест и на допуск к выполнению работ' рекомендуется заполнять две строки: одна - по разрешению на подготовку рабочего места, другая - по разрешению на допуск к работе.",
              chapterID: 0),
          Paragraph(
              id: 100397,
              num: 111,
              ...
              paragraphClass: "-",
              content:
                  "6.31. При заполнении <a href='101949'>оборотной стороны</a> наряда-допуска рекомендуется:",
              chapterID: 0),
          Paragraph(
              id: 100398,
              num: 112,
              ...
              paragraphClass: "-",
              content:
                  "1) при работах в РУ и на КЛ в <a href='101950'>строке</a> 'Рабочие места подготовлены. Под напряжением остались' допускающий указывает наименования оставшихся под напряжением токоведущих частей ремонтируемого и соседних присоединений (или оборудования соседних присоединений), ближайших к рабочему месту.",
              chapterID: 0),
          Paragraph(
              id: 100399,
              num: 113,
              ...
              paragraphClass: "-",
              content:
                  "При работах на ВЛ в этих строках записываются наименования токоведущих частей, указанные работником, выдающим наряд-допуск, в <a href='101930'>строке</a> 'Отдельные указания' лицевой стороны наряда-допуска, а при необходимости и наименования других токоведущих частей.",
              chapterID: 0),
          Paragraph(
              id: 100400,
              num: 114,
              ...
              paragraphClass: "-",
              content:
                  "Допускающему и ответственному руководителю работ (производителю работ, наблюдающему, если ответственный руководитель не назначен) рекомендуется расписываться под <a href='101950'>строкой</a> 'Рабочие места подготовлены. Под напряжением остались' только при первичном допуске к выполнению работ;",
              chapterID: 0),
          Paragraph(
              id: 100401,
              num: 115,
              ...
              paragraphClass: "-",
              content:
                  "2) в <a href='101964'>таблице</a> 'Ежедневный допуск к работе и время ее окончания' рекомендуется указывать сведения о ежедневном допуске к работе и дате и времени ее окончания, в том числе допуске при переводе на другое рабочее место.",
              chapterID: 0),
          Paragraph(
              id: 100402,
              num: 116,
              ...
              paragraphClass: "-",
              content:
                  "Если производитель работ совмещает обязанности допускающего, а также если производителю работ разрешено проводить повторный допуск бригады к выполнению работ, он расписывается в <a href='101976'>графах 3</a> и <a href='101977'>4</a>.",
              chapterID: 0),
          Paragraph(
              id: 100403,
              num: 117,
              ...
              paragraphClass: "-",
              content:
                  "Когда ответственному руководителю работ разрешено проводить повторный допуск бригады к работам, он расписывается в <a href='101976'>графе 3</a>.",
              chapterID: 0),
          Paragraph(
              id: 100404,
              num: 118,
              ...
              paragraphClass: "-",
              content:
                  "Окончание работ, связанное с окончанием рабочего дня, производителю работ или наблюдающему рекомендуется оформлять в <a href='101978'>графах 5</a> и <a href='101979'>6</a>;",
              chapterID: 0),
          Paragraph(
              id: 100405,
              num: 119,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При передаче разрешения по телефону, радио производитель работ в <a href='101999'>графе 4</a> указывает фамилию работника;",
              chapterID: 0),
          Paragraph(
              id: 100407,
              num: 121,
              ...
              paragraphClass: "-",
              content:
                  "в <a href='102000'>строке</a> 'Работа полностью закончена, бригада удалена, заземления, установленные бригадой, сняты, сообщено (кому)' рекомендуется указывать должность, фамилию, инициалы получившего информацию;",
              chapterID: 0),
          Paragraph(
              id: 100408,
              num: 122,
              ...
              paragraphClass: "-",
              content:
                  "4) После полного окончания работ производителю работ или наблюдающему и ответственному руководителю работ рекомендуется расписываться в соответствующих строках наряда-допуска, указывая при этом дату и время полного окончания работ. Если ответственный руководитель работ не назначался, то подпись в <a href='102003'>строке</a> 'Ответственный руководитель работ' не ставится.",
              chapterID: 0),
          Paragraph(
              id: 100409,
              num: 123,
    ...
    Chapter(
        id: 9,
        name: "Организация работ в электроустановках по распоряжению",
        num: "VII",
        paragraphs: [
          Paragraph(
              id: 100415,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "7.9. Допускается выполнение работ по распоряжению в электроустановках напряжением до 1000 В, кроме работ на сборных шинах РУ и на присоединениях, по которым не исключена подача напряжения на сборные шины и на ВЛ до 1000 В с использованием подъемных сооружений и механизмов. Работы по обслуживанию сети наружного освещения выполняются по распоряжению с применением механизмов при выполнении условий, предусмотренных <a href='101244'>пунктом 38.78</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100429,
              num: 14,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "другие работы, предусмотренные Правилами.",
              chapterID: 0),
          Paragraph(
              id: 100440,
              num: 25,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "без разборки конструктивных частей опоры;",
              chapterID: 0),
          Paragraph(
              id: 100444,
              num: 29,
              isHTML: false,
              paragraphClass: "-",
              content: "с откапыванием стоек опоры на глубину до 0,5 м;",
              chapterID: 0),
          Paragraph(
              id: 100445,
              num: 30,
              ...
              paragraphClass: "-",
              content:
                  "по расчистке трассы ВЛ, когда исключено падение на провода вырубаемых деревьев, сучьев, также исключено приближение на расстояние менее указанного в <a href='100095'>таблице N 1</a>, к проводам работников, осуществляющих обрубку веток и сучьев, и применяемых ими приспособлений и механизмов.",
              chapterID: 0),
          Paragraph(
              id: 100446,
              num: 31,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "восстановление постоянных обозначений на опоре;",
              chapterID: 0),
          Paragraph(
              id: 100449,
              num: 34,
              isHTML: false,
              paragraphClass: "-",
              content: "замер габаритов угломерными приборами;",
              chapterID: 0),
          Paragraph(
              id: 100450,
              num: 35,
              isHTML: false,
              paragraphClass: "-",
              content: "противопожарную очистку площадок вокруг опор;",
              chapterID: 0),
          Paragraph(
              id: 100451,
              num: 36,
              isHTML: false,
              paragraphClass: "-",
              content: "окраску бандажей на опорах.",
              chapterID: 0),
          Paragraph(
              id: 100452,
              num: 37,
    ...
    Chapter(
        id: 10,
        name:
            "Охрана труда при организации работв электроустановках, выполняемых по перечню работ в порядкетекущей эксплуатации",
        num: "VIII",
        paragraphs: [
          Paragraph(
              id: 100454,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Подготовка рабочего места и работа, разрешенная в порядке текущей эксплуатации к выполнению оперативным или оперативно-ремонтным персоналом, распространяется на электроустановки напряжением до 1000 В и выполняется только на закрепленном за этим персоналом оборудовании (участке) или в электроустановке до 1000 В потребителя в соответствии с <a href='101475'>пунктом 42.8</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100456,
              num: 2,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "работы в электроустановках с односторонним питанием;",
              chapterID: 0),
          Paragraph(
              id: 100462,
              num: 8,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "измерения, проводимые с использованием мегаомметра;",
              chapterID: 0),
          Paragraph(
              id: 100469,
              num: 15,
              ...
              paragraphClass: "-",
              content:
                  "нанесение маркировки, чистка снега, уборка территорий ОРУ, коридоров ЗРУ и электропомещений с электрооборудованием, напряжением до 1000 В, где токоведущие части ограждены или находятся на высоте недостижимой для случайного прикосновения с учетом <a href='100095'>таблицы N 1</a>;",
              chapterID: 0),
          Paragraph(
              id: 100470,
              num: 16,
    ...
    Chapter(
        id: 11,
        name:
            "Охрана труда при выдаче разрешений на подготовкурабочего места и допуск к работе в электроустановках",
        num: "IX",
        paragraphs: [
          Paragraph(
              id: 100474,
    ...
    Chapter(
        id: 12,
        name:
            "Охрана труда при подготовке рабочего местаи первичном допуске бригады к работе в электроустановкахпо наряду-допуску и распоряжению",
        num: "X",
        paragraphs: [
          Paragraph(
              id: 100479,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "10.2. В тех случаях, когда производитель работ совмещает обязанности допускающего, подготовку рабочего места он должен выполнять с одним из членов бригады, имеющим группу III по электробезопасности (за исключением случаев, предусмотренных <a href='101471'>пунктом 42.5</a> Правил).",
              chapterID: 0),
          Paragraph(
              id: 100482,
              num: 3,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "производитель работ или наблюдающий - членам бригады.",
              chapterID: 0),
          Paragraph(
              id: 100495,
              num: 16,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "производитель работ - членам бригады.",
              chapterID: 0),
          Paragraph(
              id: 100499,
              num: 20,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "10.10. При работе по наряду-допуску целевые инструктажи должны быть подписаны работниками, проведшими и получившими инструктаж, в таблицах наряда-допуска, рекомендуемый образец которого предусмотрен <a href='101911'>приложением N 7</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100506,
              num: 27,
              ...
              paragraphClass: "-",
              content:
                  "При работе по распоряжению целевые инструктажи должны быть оформлены подписями работников, проведших и получивших инструктаж, в журнале учета работ по нарядам-допускам и распоряжениям, рекомендуемый образец которого предусмотрен <a href='102006'>приложением N 8</a> к Правилам.",
              chapterID: 0),
          Paragraph(
              id: 100507,
              num: 28,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Допуск к работе по наряду-допуску и распоряжению оформляется в журнале учета работ по нарядам-допускам и распоряжениям, рекомендуемый образец которого предусмотрен <a href='102006'>приложением N 8</a> к Правилам, с записью о допуске к работе в оперативном журнале.",
              chapterID: 0),
        ]),
    Chapter(id: 13, name: "Надзор за бригадой", num: "XI", paragraphs: [
      Paragraph(
          id: 100511,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          isHTML: false,
          paragraphClass: "-",
          content: "прокладка силовых и контрольных кабелей;",
          chapterID: 0),
      Paragraph(
          id: 100519,
          num: 8,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "Указанные работы производятся по наряду-допуску на основании и условиях, предусмотренных <a href='100315'>пунктами 6.12</a> и <a href='100321'>6.13</a> Правил.",
          chapterID: 0),
      Paragraph(
          id: 100521,
          num: 10,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "Члены бригады, не имеющие право самостоятельной работы в электроустановках, могут выходить из РУ и возвращаться на рабочее место только в сопровождении работника, имеющего право единоличного осмотра электроустановок, или наблюдающего, если его могут заменить на условиях, предусмотренных <a href='100513'>пунктом 11.2</a> Правил.",
          chapterID: 0),
      Paragraph(
          id: 100525,
          num: 14,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "При изменении состава бригады должны соблюдаться требования <a href='100281'>пункта 5.15</a> Правил. Производитель работ или наблюдающий обязан провести целевые инструктажи работникам, введенным в состав бригады.",
          chapterID: 0),
      Paragraph(
          id: 100528,
          num: 17,
    ...
    Chapter(
        id: 14,
        name: "Перевод на другое рабочее место",
        num: "XII",
        paragraphs: [
          Paragraph(
              id: 100530,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "12.2. Перевод на другое рабочее место указывается в наряде-допуске. Перевод, осуществляемый допускающим из числа оперативного персонала, оформляется в двух экземплярах наряда-допуска, за исключением случаев, предусмотренных в <a href='100286'>пункте 6.1</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100532,
              num: 2,
    ...
    Chapter(
        id: 15,
        name:
            "Оформление перерывов в работе и повторных допусковк работе в электроустановке",
        num: "XIII",
        paragraphs: [
          Paragraph(
              id: 100535,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Производитель работ (наблюдающий) с разрешения допускающего имеет право допустить бригаду к работе на подготовленное рабочее место, если ему это поручено, с записью в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 100544,
              num: 9,
    ...
    Chapter(
        id: 16,
        name:
            "Сдача-приемка рабочего места, закрытие наряда-допуска,распоряжения после окончания работы в электроустановках",
        num: "XIV",
        paragraphs: [
          Paragraph(
              id: 100547,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "14.2. Производитель работ или наблюдающий должен сообщить дежурному оперативному персоналу или работнику, выдавшему наряд-допуск, о полном окончании работ и выполнении им требований <a href='100547'>пункта 14.1</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100550,
              num: 3,
    ...
    Chapter(
        id: 17,
        name:
            "Охрана труда при включении электроустановокпосле полного окончания работ",
        num: "XV",
        paragraphs: [
          Paragraph(
              id: 100554,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Предоставление права на такое включение должно быть записано в <a href='101930'>строке</a> наряда-допуска 'Отдельные указания'.",
              chapterID: 0),
          Paragraph(
              id: 100557,
              num: 3,
    ...
    Chapter(
        id: 18,
        name:
            "Охрана труда при выполнении технических мероприятий,обеспечивающих безопасность работ в электроустановках",
        num: "XVI",
        paragraphs: [
          Paragraph(
              id: 100560,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "на приводах ручного, на ключах дистанционного управления коммутационными аппаратами должны быть вывешены, а в АРМ в соответствии с требованиями <a href='100608'>главы XVIII</a> Правил отображены, запрещающие плакаты.",
              chapterID: 0),
          Paragraph(
              id: 100573,
              num: 13,
    ...
    Chapter(
        id: 19,
        name: "Охрана труда при выполнении отключенийв электроустановках",
        num: "XVII",
        paragraphs: [
          Paragraph(
              id: 100581,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "неогражденные токоведущие части, к которым возможно случайное приближение людей, механизмов и подъемных сооружений на расстояние менее указанного в <a href='100095'>таблице N 1</a>;",
              chapterID: 0),
          Paragraph(
              id: 100584,
              num: 3,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "должны быть вывешены запрещающие плакаты.",
              chapterID: 0),
          Paragraph(
              id: 100602,
              num: 21,
              ...
              paragraphClass: "-",
              content:
                  "Меры по предотвращению ошибочного включения коммутационных аппаратов КРУ с выкатными тележками должны быть приняты в соответствии с требованиями, предусмотренными <a href='100894'>пунктами 29.1</a>, <a href='100895'>29.2</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100603,
              num: 22,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Необходимо вывесить запрещающие плакаты.",
              chapterID: 0),
          Paragraph(
              id: 100607,
              num: 26,
    ...
    Chapter(
        id: 20,
        name: "Вывешивание запрещающих плакатов",
        num: "XVIII",
        paragraphs: [
          Paragraph(
              id: 100609,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "На присоединениях напряжением до 1000 В, не имеющих коммутационных аппаратов, плакат 'Не включать! Работают люди' должен быть вывешен у снятых предохранителей, в КРУ - в соответствии с <a href='100895'>пунктом 29.2</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100612,
              num: 3,
    ...
    Chapter(
        id: 21,
        name: "Охрана труда при проверке отсутствия напряжения",
        num: "XIX",
        paragraphs: [
          Paragraph(
              id: 100623,
    ...
    Chapter(
        id: 22,
        name: "Охрана труда при установке заземлений",
        num: "XX",
        paragraphs: [
          Paragraph(
              id: 100639,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "20.4. Запрещается пользоваться для заземления проводниками, не предназначенными для этой цели, кроме случаев, указанных в <a href='100851'>пункте 27.2</a> Правил.",
              chapterID: 0),
        ]),
    Chapter(
        id: 23,
        name:
            "Охрана труда при установке заземленийв распределительных устройствах",
        num: "XXI",
        paragraphs: [
          Paragraph(
              id: 100646,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "21.2. Заземленные токоведущие части должны быть отделены от токоведущих частей, находящихся под напряжением, видимым разрывом. Разрешается отсутствие видимого разрыва в случаях, указанных в <a href='100586'>пункте 17.2</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100649,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Разрешение на временное снятие заземлений, а также на выполнение этих операций производителем работ должно быть внесено в <a href='101930'>строку</a> наряда-допуска 'Отдельные указания' с записью о том, где и для какой цели должны быть сняты заземления.",
              chapterID: 0),
          Paragraph(
              id: 100656,
              num: 10,
    ...
    Chapter(
        id: 24,
        name: "Охрана труда при установке заземлений на ВЛ",
        num: "XXII",
        paragraphs: [
          Paragraph(
              id: 100661,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "22.2. Дополнительно к заземлениям, указанным в <a href='100661'>пункте 22.1</a> Правил, на рабочем месте каждой бригады должны быть заземлены провода всех фаз, а при необходимости и грозозащитные тросы.",
              chapterID: 0),
          Paragraph(
              id: 100666,
              num: 5,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "22.12. Требования к установке заземлений на ВЛ при работах в пролете пересечения с другими ВЛ, на одной отключенной цепи многоцепной ВЛ, на ВЛ под наведенным напряжением и при пофазном ремонте предусмотрены <a href='101083'>главой XXXVIII</a> Правил.",
              chapterID: 0),
        ]),
    Chapter(
        id: 25,
        name: "Ограждение рабочего места, вывешиваниеплакатов безопасности",
        num: "XXIII",
        paragraphs: [
          Paragraph(
              id: 100684,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При установке временных ограждений без снятия напряжения расстояние от них до токоведущих частей должно быть не менее, указанного в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 100687,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "23.8. Не допускается убирать или переставлять до полного окончания работы плакаты и ограждения, установленные при подготовке рабочих мест допускающим, кроме случаев, оговоренных в <a href='101930'>графе</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
        ]),
    Chapter(
        id: 26,
        name:
            "Охрана труда при работах в зоне влиянияэлектрического и магнитного полей",
        num: "XXIV",
        paragraphs: [
          Paragraph(
              id: 100704,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "E - уровень напряженности воздействующего ЭП, кВ/м;",
              chapterID: 0),
          Paragraph(
              id: 100714,
              num: 10,
              isHTML: false,
              paragraphClass: "-",
              content: "T - допустимое время пребывания персонала, час.",
              chapterID: 0),
          Paragraph(
              id: 100715,
              num: 11,
    ...
    Chapter(
        id: 27,
        name: "Таблица N 3. Допустимые уровни магнитного поля",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 100718,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "Допустимые уровни магнитного поля",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='113.35pt;'><col width='178.55pt;'><col width='161.55pt;'></colgroup><tbody><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst100720'></a>Время пребывания (час)</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst100721'></a>Допустимые уровни магнитного поля Н (А/м)/В (мкТл)</p><p class='align_center no-indent'>при воздействии</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100722'></a>общем</p></td><td><p class='align_center no-indent'><a id='dst100723'></a>локальном</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100724'></a>&lt;= 1</p></td><td><p class='align_center no-indent'><a id='dst100725'></a>1600/2000</p></td><td><p class='align_center no-indent'><a id='dst100726'></a>6400/8000</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100727'></a>2</p></td><td><p class='align_center no-indent'><a id='dst100728'></a>800/1000</p></td><td><p class='align_center no-indent'><a id='dst100729'></a>3200/4000</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100730'></a>4</p></td><td><p class='align_center no-indent'><a id='dst100731'></a>400/500</p></td><td><p class='align_center no-indent'><a id='dst100732'></a>1600/2000</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100733'></a>8</p></td><td><p class='align_center no-indent'><a id='dst100734'></a>80/100</p></td><td><p class='align_center no-indent'><a id='dst100735'></a>800/1000</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 100736,
              num: 3,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "оценке рабочих мест по условиям труда.",
              chapterID: 0),
          Paragraph(
              id: 100743,
              num: 10,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Измерения напряженности ЭП должны производиться:",
              chapterID: 0),
          Paragraph(
              id: 100745,
              num: 12,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Рабочие места и маршруты передвижения работников следует располагать на расстояниях от источников магнитного поля, при которых обеспечивается выполнение требований, предусмотренных <a href='100717'>пунктом 24.5</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100760,
              num: 27,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "24.18. Дополнительные меры безопасности при работе в зоне влияния электрического и магнитного полей должны быть отражены в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
        ]),
    Chapter(
        id: 28,
    ...
    Chapter(
        id: 29,
        name: "Охрана труда при выполнении работв электролизных установках",
        num: "XXVI",
        paragraphs: [
          Paragraph(
              id: 100775,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "26.4. Работы с открытым огнем на ресиверах, подводящих и отводящих трубопроводах на расстоянии менее 10 м от них, работы на оборудовании в помещении ЭлУ должны выполняться по наряду-допуску. Меры пожарной безопасности, обеспечивающие безопасность работ, записываются в <a href='101930'>графе</a> наряда 'Отдельные указания' наряда-допуска. Не допускается работать с огнем непосредственно на корпусах оборудования и трубопроводах, заполненных водородом.",
              chapterID: 0),
          Paragraph(
              id: 100781,
              num: 6,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Продувку ресиверов инертным газом, воздухом и водородом следует вести до достижения в них концентраций компонентов, указанных в <a href='100786'>таблице N 4</a>.",
              chapterID: 0),
          Paragraph(
              id: 100784,
              num: 9,
    ...
    Chapter(
        id: 30,
        name: "Таблица N 4. Порядок продувки ресиверов",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 100785,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "Порядок продувки ресиверов",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='113.35pt;'><col width='113.35pt;'><col width='113.35pt;'><col width='113.35pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst100787'></a>Операция вытеснения</p></td><td><p class='align_center no-indent'><a id='dst100788'></a>Место отбора</p></td><td><p class='align_center no-indent'><a id='dst100789'></a>Определяемый компонент</p></td><td><p class='align_center no-indent'><a id='dst100790'></a>Содержание компонента по норме, %</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100791'></a>Воздуха углекислым газом</p></td><td><p class='align_center no-indent'><a id='dst100792'></a>Верх ресивера</p></td><td><p class='align_center no-indent'><a id='dst100793'></a>Углекислый газ</p></td><td><p class='align_center no-indent'><a id='dst100794'></a>85</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100795'></a>Воздуха азотом</p></td><td><p class='align_center no-indent'><a id='dst100796'></a>То же</p></td><td><p class='align_center no-indent'><a id='dst100797'></a>Кислород</p></td><td><p class='align_center no-indent'><a id='dst100798'></a>3,0</p></td></tr><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst100799'></a>Углекислого газа водородом</p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst100800'></a>Низ ресивера</p></td><td><p class='align_center no-indent'><a id='dst100801'></a>Углекислый газ</p></td><td><p class='align_center no-indent'><a id='dst100802'></a>1,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100803'></a>Кислород</p></td><td><p class='align_center no-indent'><a id='dst100804'></a>0,5</p></td></tr><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst100805'></a>Азота водородом</p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst100806'></a>То же</p></td><td><p class='align_center no-indent'><a id='dst100807'></a>Азот</p></td><td><p class='align_center no-indent'><a id='dst100808'></a>1,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100809'></a>Кислород</p></td><td><p class='align_center no-indent'><a id='dst100810'></a>0,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100811'></a>Водорода углекислым газом</p></td><td><p class='align_center no-indent'><a id='dst100812'></a>Верх ресивера</p></td><td><p class='align_center no-indent'><a id='dst100813'></a>Углекислый газ</p></td><td><p class='align_center no-indent'><a id='dst100814'></a>95</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100815'></a>Водорода азотом</p></td><td><p class='align_center no-indent'><a id='dst100816'></a>То же</p></td><td><p class='align_center no-indent'><a id='dst100817'></a>Водород</p></td><td><p class='align_center no-indent'><a id='dst100818'></a>3,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100819'></a>Углекислого газа воздухом</p></td><td><p class='align_center no-indent'><a id='dst100820'></a>Низ ресивера</p></td><td><p class='align_center no-indent'><a id='dst100821'></a>Углекислый газ</p></td><td><p class='align_center no-indent'><a id='dst100822'></a>Отсутствие</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100823'></a>Азота воздухом</p></td><td><p class='align_center no-indent'><a id='dst100824'></a>То же</p></td><td><p class='align_center no-indent'><a id='dst100825'></a>Кислород</p></td><td><p class='align_center no-indent'><a id='dst100826'></a>20</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 100827,
              num: 3,
              ...
              paragraphClass: "-",
              content:
                  "26.6. При отключении ЭлУ более чем на 4 часа продувка азотом ее аппаратов и трубопроводов обязательна. В случае отключения на 1 - 4 часа разрешается оставить систему под давлением водорода или кислорода в пределах (9,807 - 19,614) x 10 Па<sup>3</sup> (0,1 - 0,2 кгс/см<sup>2</sup>). При отключении установки менее чем на 1 час разрешается оставлять аппаратуру под номинальным давлением газов, при этом сигнализация повышения разности давлений в регуляторах давления водорода и кислорода не должна отключаться.",
              chapterID: 0),
          Paragraph(
              id: 100828,
              num: 4,
    ...
    Chapter(
        id: 31,
        name: "Охрана труда при выполнении работна электродвигателях",
        num: "XXVII",
        paragraphs: [
          Paragraph(
              id: 100848,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "27.6. Работы по одному наряду-допуску на электродвигателях одного напряжения, выведенных в ремонт агрегатов, технологических линий, установок могут проводиться на условиях, предусмотренных <a href='100311'>пунктом 6.9</a> Правил. Допуск на все заранее подготовленные рабочие места разрешается выполнять одновременно, оформление перевода с одного рабочего места на другое не требуется. При этом запрещается опробование или включение в работу любого из перечисленных в наряде-допуске электродвигателей до полного окончания работы на других электродвигателях.",
              chapterID: 0),
          Paragraph(
              id: 100861,
              num: 13,
    ...
    Chapter(
        id: 32,
        name: "Охрана труда при выполнении работна коммутационных аппаратах",
        num: "XXVIII",
        paragraphs: [
          Paragraph(
              id: 100873,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "отключить цепи управления;",
              chapterID: 0),
          Paragraph(
              id: 100877,
              num: 4,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Операции по опробованию коммутационного аппарата имеет право осуществлять производитель работ, если на это получено разрешение выдавшего наряд-допуск и подтверждено записью в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска, либо оперативный персонал по требованию производителя работ.",
              chapterID: 0),
          Paragraph(
              id: 100891,
              num: 18,
    ...
    Chapter(
        id: 33,
        name:
            "Охрана труда при выполнении работ в комплектныхраспределительных устройствах",
        num: "XXIX",
        paragraphs: [
          Paragraph(
              id: 100894,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При установке заземлений в шкафу КРУ в случае работы на отходящих ВЛ необходимо учитывать требования, предусмотренные <a href='100661'>пунктом 22.1</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100900,
              num: 6,
    ...
    Chapter(
        id: 34,
        name:
            "Охрана труда при выполнении работ на мачтовых(столбовых) трансформаторных подстанциях и комплектныхтрансформаторных подстанциях",
        num: "XXX",
        paragraphs: [
          Paragraph(
              id: 100904,
    ...
    Chapter(
        id: 35,
        name:
            "Охрана труда при выполнении работна силовых трансформаторах, масляных шунтирующихи дугогасящих реакторах",
        num: "XXXI",
        paragraphs: [
          Paragraph(
              id: 100909,
              ...
              paragraphClass: "-",
              content:
                  "31.1. Осмотр силовых трансформаторов (далее - трансформаторы), масляных шунтирующих и дугогасящих реакторов (далее - реакторы) должен выполняться непосредственно с земли или со стационарных лестниц с поручнями с соблюдением расстояний до токоведущих частей, указанных в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 100910,
              num: 1,
    ...
    Chapter(
        id: 36,
        name:
            "Охрана труда при выполнении работ на измерительныхтрансформаторах тока",
        num: "XXXII",
        paragraphs: [
          Paragraph(
              id: 100921,
    ...
    Chapter(
        id: 37,
        name: "Охрана труда при выполнении работна электрических котлах",
        num: "XXXIII",
        paragraphs: [
          Paragraph(
              id: 100925,
    ...
    Chapter(
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "34.3. Запрещается во время нахождения работников в электрофильтре включать механизмы встряхивания для опробования и регулировки, если это не оговорено в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 100933,
              num: 3,
    ...
    Chapter(
        id: 39,
        name: "Охрана труда при выполнении работс аккумуляторными батареями",
        num: "XXXV",
        paragraphs: [
          Paragraph(
              id: 100936,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "35.2. Запрещается курение в аккумуляторном помещении, вход в него с огнем, пользование электронагревательными приборами, аппаратами и инструментами, которые могут дать искру, за исключением выполнения работ, указанных в <a href='100952'>пункте 35.11</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 100938,
              num: 2,
    ...
    Chapter(
        id: 40,
        name: "Охрана труда при выполнении работна конденсаторных установках",
        num: "XXXVI",
        paragraphs: [
          Paragraph(
              id: 100960,
    ...
    Chapter(
        id: 41,
        name: "Охрана труда при выполнении работна кабельных линиях",
        num: "XXXVII",
        paragraphs: [
          Paragraph(
              id: 100966,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "37.8. При условиях, отличающихся от условий, приведенных в <a href='100976'>пункте 37.7</a> Правил, котлованы и траншеи следует разрабатывать с откосами без креплений либо с вертикальными стенками, закрепленными на всю высоту.",
              chapterID: 0),
          Paragraph(
              id: 100980,
              num: 14,
    ...
    Chapter(
        id: 42,
        name:
            "Таблица N 5. Расстояние по горизонтали от основания откоса выемки до ближайшей опоры машины",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 100982,
          ...
          Paragraph(
              ...
              paragraphClass: "align_center",
              content:
                  "Расстояние по горизонтали от основания откоса выемкидо ближайшей опоры машины",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='107.7pt;'><col width='86.4pt;'><col width='86.4pt;'><col width='86.4pt;'><col width='86.4pt;'></colgroup><tbody><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst100984'></a>Глубина выемки, м</p></td><td colspan='4'><p class='align_center no-indent'><a id='dst100985'></a>Грунт</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100986'></a>песчаный</p></td><td><p class='align_center no-indent'><a id='dst100987'></a>супесчаный</p></td><td><p class='align_center no-indent'><a id='dst100988'></a>суглинистый</p></td><td><p class='align_center no-indent'><a id='dst100989'></a>глинистый</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100990'></a>1,0</p></td><td><p class='align_center no-indent'><a id='dst100991'></a>1,5</p></td><td><p class='align_center no-indent'><a id='dst100992'></a>1,25</p></td><td><p class='align_center no-indent'><a id='dst100993'></a>1,00</p></td><td><p class='align_center no-indent'><a id='dst100994'></a>1,00</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst100995'></a>2,0</p></td><td><p class='align_center no-indent'><a id='dst100996'></a>3,0</p></td><td><p class='align_center no-indent'><a id='dst100997'></a>2,40</p></td><td><p class='align_center no-indent'><a id='dst100998'></a>2,00</p></td><td><p class='align_center no-indent'><a id='dst100999'></a>1,50</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101000'></a>3,0</p></td><td><p class='align_center no-indent'><a id='dst101001'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101002'></a>3,60</p></td><td><p class='align_center no-indent'><a id='dst101003'></a>3,25</p></td><td><p class='align_center no-indent'><a id='dst101004'></a>1,75</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101005'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101006'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst101007'></a>4,40</p></td><td><p class='align_center no-indent'><a id='dst101008'></a>4,00</p></td><td><p class='align_center no-indent'><a id='dst101009'></a>3,00</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101010'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst101011'></a>6,0</p></td><td><p class='align_center no-indent'><a id='dst101012'></a>5,30</p></td><td><p class='align_center no-indent'><a id='dst101013'></a>4,75</p></td><td><p class='align_center no-indent'><a id='dst101014'></a>3,50</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101015,
              num: 3,
    ...
    Chapter(
        id: 43,
        name:
            "Охрана труда при выполнении работ на воздушныхлиниях электропередачи",
        num: "XXXVIII",
        paragraphs: [
          Paragraph(
              id: 101084,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "III - при всех видах работ до верха опоры;",
              chapterID: 0),
          Paragraph(
              id: 101095,
              num: 11,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "38.17. Окраску опоры с подъемом до ее верха могут с соблюдением требований <a href='101093'>пункта 38.6</a> Правил выполнять работники, имеющие группу II по электробезопасности. При окраске опоры должны быть приняты меры для предотвращения попадания краски на изоляторы и провода (например, применены поддоны).",
              chapterID: 0),
          Paragraph(
              id: 101113,
              num: 29,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;2&gt; <a href='undefined' data-document-link='{&quot;type&quot;:&quot;otherBase&quot;,&quot;base&quot;:&quot;OTN&quot;,&quot;num&quot;:30381,&quot;dst&quot;:100332}'>Раздел 5.7</a> ГОСТ 12.4.307-2016 'Система стандартов безопасности труда (ССБТ). Перчатки диэлектрические из полимерных материалов. Общие технические требования и методы испытаний (Издание с Поправкой)' (введен в действие <a href='undefined'>приказом</a> Росстандарта от 26 декабря 2016 г. N 2076-ст) (Официальное издание. М.: Стандартинформ, 2019 год) (далее - ГОСТ 12.4.307-2016).",
              chapterID: 0),
          Paragraph(
              id: 101122,
              num: 38,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;3&gt; <a href='undefined' data-document-link='{&quot;type&quot;:&quot;otherBase&quot;,&quot;base&quot;:&quot;OTN&quot;,&quot;num&quot;:30381,&quot;dst&quot;:100332}'>Раздел 5.7</a> ГОСТ 12.4.307-2016.",
              chapterID: 0),
          Paragraph(
              id: 101126,
              num: 42,
              ...
              paragraphClass: "-",
              content:
                  "При выполнении работ методом на расстоянии устанавливать изолирующие покрытия (накладки) на токоведущие части электроустановки не требуется. При работе со штангами необходимо применять диэлектрические перчатки соответствующего класса испытательного напряжения &lt;4&gt;, при этом расстояние от работника до токоведущих частей должно быть не менее указанного в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 101127,
              num: 43,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;4&gt; <a href='undefined' data-document-link='{&quot;type&quot;:&quot;otherBase&quot;,&quot;base&quot;:&quot;OTN&quot;,&quot;num&quot;:30381,&quot;dst&quot;:100332}'>Раздел 5.7</a> ГОСТ 12.4.307-2016.",
              chapterID: 0),
          Paragraph(
              id: 101129,
              num: 45,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "выравнивание потенциалов экранирующего комплекта, рабочей площадки и провода специальной штангой для переноса потенциала. Расстояние от работника до заземленных частей и элементов оборудования при работах должно быть не менее расстояния, указанного в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 101133,
              num: 49,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;5&gt; <a href='undefined' data-document-link='{&quot;type&quot;:&quot;otherBase&quot;,&quot;base&quot;:&quot;OTN&quot;,&quot;num&quot;:30381,&quot;dst&quot;:100332}'>Раздел 5.7</a> ГОСТ 12.4.307-2016.",
              chapterID: 0),
          Paragraph(
              id: 101138,
              num: 54,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;6&gt; <a href='undefined' data-document-link='{&quot;type&quot;:&quot;otherBase&quot;,&quot;base&quot;:&quot;OTN&quot;,&quot;num&quot;:30381,&quot;dst&quot;:100332}'>Раздел 5.7</a> ГОСТ 12.4.307-2016.",
              chapterID: 0),
          Paragraph(
              id: 101142,
              num: 58,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При использовании подъемника (вышки) с изолирующим звеном расстояние от токоведущих частей находящихся под напряжением до ближайшей токопроводящей части стрелы подъемника должно быть не менее указанной в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 101145,
              num: 61,
              ...
              paragraphClass: "-",
              content:
                  "При выполнении работ под напряжением в электроустановках напряжением до и выше 1000 В по первой схеме по методу, указанному в <a href='101119'>подпункте 'а'</a> настоящего пункта, и третьей схеме, необходимо:",
              chapterID: 0),
          Paragraph(
              id: 101146,
              num: 62,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "В электроустановках до 1000 В члены бригады, имеющие право выполнения работ под напряжением на токоведущих частях, должны иметь группу по электробезопасности не ниже III, ответственный руководитель работ и производитель работ - не ниже IV группы по электробезопасности (за исключением случаев, предусмотренных <a href='101262'>пунктами 38.88</a>, <a href='101263'>38.89</a> Правил).",
              chapterID: 0),
          Paragraph(
              id: 101151,
              num: 67,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "38.37. При работе на проводах, в пролете пересечения с другой ВЛ, выполняемой с телескопической вышки (подъемника), рабочая площадка вышки должна быть с помощью специальной штанги соединена с проводом линии гибким медным проводником сечением не менее 10 мм<sup>2</sup>, а сама вышка заземлена.",
              chapterID: 0),
          Paragraph(
              id: 101167,
              num: 83,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Сведения о наличии наведенного напряжения на ВЛ должны быть указаны в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска. Значение расчетного наведенного напряжения на ВЛ указывается в перечне ВЛ под наведенным напряжением.",
              chapterID: 0),
          Paragraph(
              id: 101180,
              num: 96,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При невозможности обеспечить уравнивание потенциалов на рабочем месте (например, при работе с деревянной опоры), работы необходимо выполнять в соответствии с <a href='101196'>пунктами 38.47</a> или <a href='101197'>38.48</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101196,
              num: 112,
              ...
              paragraphClass: "-",
              content:
                  "38.47. Работы с заземлением ВЛ с обеих сторон в РУ и на рабочем месте с использованием технологии 'без снятия напряжения' должны производиться с выполнением мероприятий, предусмотренных в <a href='101117'>пунктах 38.21</a> - <a href='101160'>38.32</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101197,
              num: 113,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "выводимая в ремонт ВЛ со стороны РУ не заземляется;",
              chapterID: 0),
          Paragraph(
              id: 101199,
              num: 115,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "38.49. На ВЛ (на одном электрически связанном участке) под наведенным напряжением не допускается одновременная работа бригад, использующих различную подготовку рабочего места производства работ с наложением заземления на ВЛ, указанную в <a href='101186'>пункте 38.45</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101205,
              num: 121,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Условия производства работ при пофазном ремонте ВЛ напряжением 35 кВ и выше должны быть указаны в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 101224,
              num: 140,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "38.80. Работа на проводах ВЛЗ 6 - 20 кВ должна проводиться с отключением ВЛ, за исключением работ, выполняемых под напряжением на токоведущих частях, проводимых в соответствии с требованиями <a href='101117'>пункта 38.21</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101250,
              num: 166,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "38.82. Расстояние от работников до проводов ВЛ и других элементов, соединенных с проводами, расстояние от проводов ВЛ до механизмов и подъемных сооружений должно быть не менее указанных в <a href='100095'>таблице N 1</a>. Расстояние от провода с защитным покрытием до деревьев должно быть не менее 0,55 м.",
              chapterID: 0),
          Paragraph(
              id: 101256,
              num: 172,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Производитель работ и член бригады должны пройти подготовку и получить право на проведение работ без снятия напряжения на ВЛИ 0,38 кВ, а также допуск к работам на высоте, с обязательным применением средств защиты от падения с высоты, о чем должна быть сделана соответствующая запись в <a href='101813'>строке</a> 'Свидетельство на право проведения специальных работ' удостоверения о проверке знаний правил работы в электроустановках, рекомендуемый образец которого предусмотрен <a href='101756'>приложением N 2</a> к Правилам.",
              chapterID: 0),
        ]),
    Chapter(
        id: 44,
        name: "Охрана труда при проведении испытанийи измерений",
        num: "XXXIX",
        paragraphs: [
          Paragraph(
              id: 101266,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Допуск к испытаниям электрооборудования в действующих электроустановках осуществляет оперативный персонал в соответствии с <a href='100478'>главой X</a> Правил, а вне электроустановок - ответственный руководитель работ или, если он не назначен, производитель работ.",
              chapterID: 0),
          Paragraph(
              id: 101272,
              num: 6,
              ...
              paragraphClass: "-",
              content:
                  "Проведение испытаний в процессе работ по монтажу или ремонту оборудования должно оговариваться в <a href='101920'>строке</a> 'поручается' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 101273,
              num: 7,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Разрешение на временное снятие заземлений должно быть указано в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
          Paragraph(
              id: 101285,
              num: 19,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Сечение медного провода, применяемого в испытательных схемах для заземления, должно быть не менее 4 мм<sup>2</sup>.",
              chapterID: 0),
          Paragraph(
              id: 101288,
              num: 22,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Этот провод следует закреплять так, чтобы избежать приближения (подхлестывания) к находящимся под напряжением токоведущим частям на расстояние менее указанного в <a href='100095'>таблице N 1</a>.",
              chapterID: 0),
          Paragraph(
              id: 101293,
              num: 27,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Указанная работа должна проводиться по распоряжению.",
              chapterID: 0),
          Paragraph(
              id: 101305,
              num: 39,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "снять заземление с проводки импульсного измерителя.",
              chapterID: 0),
          Paragraph(
              id: 101314,
              num: 48,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "39.28. Измерения мегаомметром в процессе эксплуатации разрешается выполнять обученным работникам из числа электротехнического персонала. В электроустановках напряжением выше 1000 В измерения производятся по наряду-допуску, кроме работ, указанных в <a href='100423'>пунктах 7.6</a>, <a href='100427'>7.8</a> Правил, в электроустановках напряжением до 1000 В и во вторичных цепях - по распоряжению или по перечню работ, выполняемых в порядке текущей эксплуатации.",
              chapterID: 0),
          Paragraph(
              id: 101319,
              num: 53,
    ...
    Chapter(
        id: 45,
        name: "Охрана труда при обмыве и чистке изоляторовпод напряжением",
        num: "XL",
        paragraphs: [
          Paragraph(
              id: 101324,
    ...
    Chapter(
        id: 46,
        name:
            "Таблица N 6. Минимально допустимые расстояния по струе воды между насадкой и обмываемым изолятором",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101325,
          ...
          Paragraph(
              ...
              paragraphClass: "align_center",
              content:
                  "Минимально допустимые расстояния по струе водымежду насадкой и обмываемым изолятором",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='138.9pt;'><col width='52.4pt;'><col width='52.4pt;'><col width='52.4pt;'><col width='52.4pt;'><col width='52.4pt;'><col width='52.5pt;'></colgroup><tbody><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst101327'></a>Диаметр выходного отверстия насадки, мм</p></td><td colspan='6'><p class='align_center no-indent'><a id='dst101328'></a>Минимально допустимое расстояние по струе, м, при напряжении электроустановки, кВ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101329'></a>до 10</p></td><td><p class='align_center no-indent'><a id='dst101330'></a>35</p></td><td><p class='align_center no-indent'><a id='dst101331'></a>110 - 150</p></td><td><p class='align_center no-indent'><a id='dst101332'></a>220</p></td><td><p class='align_center no-indent'><a id='dst101333'></a>330</p></td><td><p class='align_center no-indent'><a id='dst101334'></a>500</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101335'></a>10</p></td><td><p class='align_center no-indent'><a id='dst101336'></a>3,0</p></td><td><p class='align_center no-indent'><a id='dst101337'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101338'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst101339'></a>6,0</p></td><td><p class='align_center no-indent'><a id='dst101340'></a>7,0</p></td><td><p class='align_center no-indent'><a id='dst101341'></a>8,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101342'></a>12</p></td><td><p class='align_center no-indent'><a id='dst101343'></a>3,5</p></td><td><p class='align_center no-indent'><a id='dst101344'></a>4,5</p></td><td><p class='align_center no-indent'><a id='dst101345'></a>6,0</p></td><td><p class='align_center no-indent'><a id='dst101346'></a>8,0</p></td><td><p class='align_center no-indent'><a id='dst101347'></a>9,0</p></td><td><p class='align_center no-indent'><a id='dst101348'></a>10,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101349'></a>14</p></td><td><p class='align_center no-indent'><a id='dst101350'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101351'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst101352'></a>6,5</p></td><td><p class='align_center no-indent'><a id='dst101353'></a>8,5</p></td><td><p class='align_center no-indent'><a id='dst101354'></a>9,5</p></td><td><p class='align_center no-indent'><a id='dst101355'></a>11,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101356'></a>16</p></td><td><p class='align_center no-indent'><a id='dst101357'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101358'></a>6,0</p></td><td><p class='align_center no-indent'><a id='dst101359'></a>7,0</p></td><td><p class='align_center no-indent'><a id='dst101360'></a>9,0</p></td><td><p class='align_center no-indent'><a id='dst101361'></a>10,0</p></td><td><p class='align_center no-indent'><a id='dst101362'></a>12,0</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101363,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "При обмыве с телескопической вышки ствол с насадкой должен быть соединен с корзиной вышки и рамой автоцистерны гибким медным проводником сечением не менее 25 мм<sup>2</sup>.",
              chapterID: 0),
          Paragraph(
              id: 101365,
              num: 5,
    ...
    Chapter(
        id: 47,
        name:
            "Охрана труда при выполнении работ со средствами связи,диспетчерского и технологического управления",
        num: "XLI",
        paragraphs: [
          Paragraph(
              id: 101375,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.2. Ответственный руководитель работ должен назначаться при работах, выполняемых согласно <a href='100221'>пункту 5.7</a> Правил, и работах:",
              chapterID: 0),
          Paragraph(
              id: 101377,
              num: 2,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.4. В устройствах СДТУ по распоряжению разрешается проводить работы, указанные в <a href='100414'>главе VII</a> Правил, и работы:",
              chapterID: 0),
          Paragraph(
              id: 101384,
              num: 9,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.6. Работа на устройствах СДТУ, расположенных на территории РУ, должна быть организована в соответствии с <a href='100334'>пунктом 6.17</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101388,
              num: 13,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "монтаж, демонтаж и перекладка кабеля;",
              chapterID: 0),
          Paragraph(
              id: 101404,
              num: 29,
              isHTML: false,
              paragraphClass: "-",
              content: "ремонт поврежденной телефонной связи;",
              chapterID: 0),
          Paragraph(
              id: 101405,
              num: 30,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.23. Работы в подземных сооружениях КЛС должны выполняться в соответствии с требованиями <a href='101055'>пунктов 37.35</a> - <a href='101082'>37.51</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101414,
              num: 39,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.30. При натягивании и регулировке проводов связи, проходящих под (над) линией электропередачи, должны соблюдаться требования, предусмотренные <a href='101173'>пунктом 38.40</a> Правил с учетом требований <a href='101083'>главы XXXVIII</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101422,
              num: 47,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "41.32. При работах на ВЛС, находящихся под наведенным напряжением, должны выполняться <a href='101177'>требования 38.43</a> - <a href='101214'>38.57</a> Правил, относящиеся к работам на ВЛ под наведенным напряжением.",
              chapterID: 0),
          Paragraph(
              id: 101425,
              num: 50,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "Антенну следует натягивать осторожно, без рывков.",
              chapterID: 0),
          Paragraph(
              id: 101454,
              num: 79,
              ...
              paragraphClass: "-",
              content:
                  "41.49. При подъеме и спуске антенны один работник, стоящий в середине пролета в стороне от трассы, должен следить за тем, чтобы антенна не приближалась к проводам ВЛ, находящимся под напряжением, на расстояние менее указанного в <a href='101450'>пункте 41.47</a> Правил. Не разрешается находиться под проводом антенны.",
              chapterID: 0),
          Paragraph(
              id: 101455,
              num: 80,
    ...
    Chapter(
        id: 48,
        name:
            "Охрана труда при выполнении работв устройствах релейной защиты и электроавтоматики,со средствами измерений и приборами учетаэлектроэнергии, вторичными цепями",
        num: "XLII",
        paragraphs: [
          Paragraph(
              id: 101466,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "42.4. Проверка, опробование действия устройств релейной защиты, электроавтоматики, в том числе с отключением или включением коммутационных аппаратов, должна производиться в соответствии с <a href='100430'>пунктом 7.11</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101471,
              num: 5,
    ...
    Chapter(
        id: 49,
        name:
            "Охрана труда при выполнении работв электрической части устройств тепловой автоматики,теплотехнических измерений и защит",
        num: "XLIII",
        paragraphs: [
          Paragraph(
              id: 101481,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "43.2. Операции с коммутационной аппаратурой на пультах, распределительных щитах и сборках устройств ТАИ имеет право выполнять оперативный персонал или по наряду-допуску производитель работ, если разрешение на такие операции подтверждены записью в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска, или по распоряжению с записью в <a href='102023'>графе 7</a> журнала учета работ по нарядам-допускам и распоряжениям.",
              chapterID: 0),
          Paragraph(
              id: 101483,
              num: 2,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "наладка регистрационной части приборов;",
              chapterID: 0),
          Paragraph(
              id: 101489,
              num: 8,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "уплотнение коробок зажимов;",
              chapterID: 0),
          Paragraph(
              id: 101495,
              num: 14,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "обдувка щитов, панелей сжатым воздухом.",
              chapterID: 0),
          Paragraph(
              id: 101497,
              num: 16,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "43.7. При проведении работ на сборках задвижек, на приводах задвижек и регуляторов должны соблюдаться требования <a href='100161'>глав IV</a>, <a href='100847'>XXVII</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101499,
              num: 18,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Производителю работ, имеющему группу IV, из числа электротехнического персонала разрешается совмещать обязанности допускающего и определять меры безопасности в электрической части устройств ТАИ при подготовке рабочего места с записью в <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска.",
              chapterID: 0),
        ]),
    Chapter(
        id: 50,
        name:
            "Охрана труда при работе с переноснымэлектроинструментом и светильниками, ручными электрическимимашинами, разделительными трансформаторами",
        num: "XLIV",
        paragraphs: [
          Paragraph(
              id: 101502,
    ...
    Chapter(
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "align_center",
              content:
                  "Условия использования в работе электроинструмента и ручныхэлектрических машин различных классов",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='104.9pt;'><col width='158.75pt;'><col width='189.9pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101508'></a>Место проведения работ</p></td><td><p class='align_center no-indent'><a id='dst101509'></a>Класс электроинструмента и ручных электрических машин по типу защиты от поражения электрическим током</p></td><td><p class='align_center no-indent'><a id='dst101510'></a>Условия применения электрозащитных средств</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101511'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101512'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101513'></a>3</p></td></tr><tr><td rowspan='3'><p class='align_left no-indent'><a id='dst101514'></a>Помещения без повышенной опасности</p></td><td><p class='align_center no-indent'><a id='dst101515'></a>I</p></td><td><p class='no-indent'><a id='dst101516'></a>При системе TN-S - без применения электрозащитных средств при подключении через устройство защитного отключения или с применением хотя бы одного электрозащитного средства.</p><p class='no-indent'>При системе TN-C - с применением хотя бы одного электрозащитного средства</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101517'></a>II</p></td><td><p class='no-indent'><a id='dst101518'></a>Без применения электрозащитных средств</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101519'></a>III</p></td><td><p class='no-indent'><a id='dst101520'></a>Без применения электрозащитных средств</p></td></tr><tr><td rowspan='3'><p class='align_left no-indent'><a id='dst101521'></a>Помещения с повышенной опасностью</p></td><td><p class='align_center no-indent'><a id='dst101522'></a>I</p></td><td><p class='no-indent'><a id='dst101523'></a>При системе TN-S - без применения электрозащитных средств при подключении через устройство защитного отключения или при питании только одного электроприемника (машина, инструмент) от отдельного источника (разделительный трансформатор, генератор, преобразователь).</p><p class='no-indent'>При системе TN-C - с применением хотя бы одного электрозащитного средства</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101524'></a>II</p></td><td><p class='no-indent'><a id='dst101525'></a>Без применения электрозащитных средств</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101526'></a>III</p></td><td><p class='no-indent'><a id='dst101527'></a>Без применения электрозащитных средств</p></td></tr><tr><td rowspan='3'><p class='align_left no-indent'><a id='dst101528'></a>Особо опасные помещения</p></td><td><p class='align_center no-indent'><a id='dst101529'></a>I</p></td><td><p class='no-indent'><a id='dst101530'></a>С защитой устройством защитного отключения или с применением хотя бы одного электрозащитного средства</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101531'></a>II</p></td><td><p class='no-indent'><a id='dst101532'></a>Без применения электрозащитных средств</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101533'></a>III</p></td><td><p class='no-indent'><a id='dst101534'></a>Без применения электрозащитных средств</p></td></tr><tr><td rowspan='3'><p class='align_left no-indent'><a id='dst101535'></a>При наличии особо неблагоприятных условий (в сосудах, аппаратах и других металлических емкостях с ограниченной возможностью перемещения и выхода)</p></td><td><p class='align_center no-indent'><a id='dst101536'></a>I</p></td><td><p class='no-indent'><a id='dst101537'></a>Не допускается применять</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101538'></a>II</p></td><td><p class='no-indent'><a id='dst101539'></a>С применением хотя бы одного электрозащитного средства</p><p class='no-indent'>Без применения электрозащитных средств при подключении через устройство защитного отключения или при питании только одного электроприемника от отдельного источника</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101540'></a>III</p></td><td><p class='no-indent'><a id='dst101541'></a>Без применения электрозащитных средств</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101542,
              num: 3,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "определить по паспорту класс машины или инструмента;",
              chapterID: 0),
          Paragraph(
              id: 101546,
              num: 7,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "проверить четкость работы выключателя;",
              chapterID: 0),
          Paragraph(
              id: 101549,
              num: 10,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "работать с приставных лестниц;",
              chapterID: 0),
          Paragraph(
              id: 101567,
              num: 28,
    ...
    Chapter(
        id: 52,
        name:
            "Охрана труда при выполнении работв электроустановках с применением автомобилей, подъемныхсооружений и механизмов, лестниц",
        num: "XLV",
        paragraphs: [
          Paragraph(
              id: 101573,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "В <a href='101930'>строке</a> 'Отдельные указания' наряда-допуска должна быть сделана запись о назначении работника (специалиста), ответственного за безопасное производство работ с применением подъемных сооружений с указанием должности, фамилии и инициалов, а также выполняемых работ под его непосредственным руководством.",
              chapterID: 0),
          Paragraph(
              id: 101578,
              num: 5,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "для персонала, обслуживающего электроустановки не менее указанных в <a href='100095'>таблице N 1</a>;",
              chapterID: 0),
          Paragraph(
              id: 101586,
              num: 13,
              ...
              paragraphClass: "-",
              content:
                  "для персонала строительно-монтажных организаций не менее указанных в <a href='101654'>таблице N 8</a>, предусмотренной <a href='101652'>пунктом 47.15</a> Правил (далее - таблица N 8).",
              chapterID: 0),
          Paragraph(
              id: 101587,
              num: 14,
    ...
    Chapter(
        id: 53,
        name: "Охрана труда при организации работкомандированного персонала",
        num: "XLVI",
        paragraphs: [
          Paragraph(
              id: 101605,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "46.5. Предоставление командированному персоналу права работы в действующих электроустановках в качестве выдающих наряды-допуски и распоряжения, ответственных руководителей и производителей работ, допускающих на ВЛ в соответствии с <a href='100260'>пунктом 5.13</a> Правил, членов бригады разрешается оформить руководителем организации (обособленного подразделения) - владельцем электроустановки резолюцией на письме командирующей организации или ОРД организации (обособленного подразделения).",
              chapterID: 0),
          Paragraph(
              id: 101612,
              num: 7,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "46.7. Командирующая организация является ответственной за соответствие присвоенных командированному персоналу групп и прав, предоставляемых ему в соответствии с <a href='101608'>пунктом 46.3</a> Правил, а также за соблюдение им Правил.",
              chapterID: 0),
          Paragraph(
              id: 101615,
              num: 10,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "&lt;7&gt; <a href='undefined'>Постановление</a> Правительства Российской Федерации от 27 декабря 2004 г. N 861 'Об утверждении Правил недискриминационного доступа к услугам по передаче электрической энергии и оказания этих услуг, Правил недискриминационного доступа к услугам по оперативно-диспетчерскому управлению в электроэнергетике и оказания этих услуг, Правил недискриминационного доступа к услугам администратора торговой системы оптового рынка и оказания этих услуг и Правил технологического присоединения энергопринимающих устройств потребителей электрической энергии, объектов по производству электрической энергии, а также объектов электросетевого хозяйства, принадлежащих сетевым организациям и иным лицам, к электрическим сетям' (Собрание законодательства Российской Федерации, 2004, N 52, ст. 5525; 2020, N 11, ст. 1564).",
              chapterID: 0),
          Paragraph(
              id: 101624,
              num: 19,
    ...
    Chapter(
        id: 54,
        name:
            "Охрана труда при допуске персоналастроительно-монтажных организаций к работам в действующихэлектроустановках и в охранной зоне линий электропередачи",
        num: "XLVII",
        paragraphs: [
          Paragraph(
              id: 101628,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "47.3. Актом-допуском должны быть определены:",
              chapterID: 0),
          Paragraph(
              id: 101632,
              num: 4,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "-",
              content: "место входа (выхода) и въезда (выезда) в зону работ;",
              chapterID: 0),
          Paragraph(
              id: 101635,
              num: 7,
              isHTML: false,
              paragraphClass: "-",
              content: "наличие опасных и вредных факторов.",
              chapterID: 0),
          Paragraph(
              id: 101636,
              num: 8,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "Выполнение работ в охранной зоне отключенной линии электропередачи и на самой отключенной линии проводится с разрешения допускающего организации, эксплуатирующей линию электропередачи, после установки заземлений, выполняемой в соответствии с требованиями <a href='100660'>главы XXII</a> Правил.",
              chapterID: 0),
          Paragraph(
              id: 101652,
              num: 24,
              ...
              paragraphClass: "-",
              content:
                  "47.15. Выполнение работ СМО в охранных зонах ВЛ с использованием подъемных машин и механизмов с выдвижной частью допускается с учетом требований <a href='101582'>пункта 45.6</a> Правил и только при условии, если расстояние по воздуху от машины (механизма) или от ее выдвижной или подъемной части, от ее рабочего органа или поднимаемого груза в любом положении до ближайшего провода, находящегося под напряжением, будет не менее расстояния, указанного в таблице N 8.",
              chapterID: 0),
        ]),
    Chapter(
        id: 55,
        name:
            "Таблица N 8. Допустимые расстояния до токоведущих частей, находящихся под напряжением",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101653,
          ...
          Paragraph(
              ...
              paragraphClass: "align_center",
              content:
                  "Допустимые расстояния до токоведущих частей, находящихсяпод напряжением",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='170.1pt;'><col width='141.7pt;'><col width='141.7pt;'></colgroup><tbody><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst101655'></a>Напряжение ВЛ, кВ</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101656'></a>Расстояние, м</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101657'></a>минимальное</p></td><td><p class='align_center no-indent'><a id='dst101658'></a>минимальное, измеряемое техническими средствами</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101659'></a>до 1</p></td><td><p class='align_center no-indent'><a id='dst101660'></a>1,5</p></td><td><p class='align_center no-indent'><a id='dst101661'></a>1,5</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101662'></a>свыше 1 до 20</p></td><td><p class='align_center no-indent'><a id='dst101663'></a>2,0</p></td><td><p class='align_center no-indent'><a id='dst101664'></a>2,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101665'></a>свыше 20 до 35</p></td><td><p class='align_center no-indent'><a id='dst101666'></a>2,0</p></td><td><p class='align_center no-indent'><a id='dst101667'></a>2,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101668'></a>свыше 35 до 110</p></td><td><p class='align_center no-indent'><a id='dst101669'></a>3,0</p></td><td><p class='align_center no-indent'><a id='dst101670'></a>4,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101671'></a>свыше 110 до 220</p></td><td><p class='align_center no-indent'><a id='dst101672'></a>4,0</p></td><td><p class='align_center no-indent'><a id='dst101673'></a>5,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101674'></a>свыше 220 до 400</p></td><td><p class='align_center no-indent'><a id='dst101675'></a>5,0</p></td><td><p class='align_center no-indent'><a id='dst101676'></a>7,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101677'></a>свыше 400 до 750</p></td><td><p class='align_center no-indent'><a id='dst101678'></a>9,0</p></td><td><p class='align_center no-indent'><a id='dst101679'></a>10,0</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101680'></a>свыше 750 до 1150</p></td><td><p class='align_center no-indent'><a id='dst101681'></a>10,0</p></td><td><p class='align_center no-indent'><a id='dst101682'></a>11,0</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101683,
              num: 3,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "47.18. Прокол кабеля должен выполняться работниками организации, эксплуатирующей КЛ, в соответствии с <a href='101028'>пунктом 37.19</a> Правил.",
              chapterID: 0),
        ]),
    Chapter(
        id: 56,
        name:
            "ГРУППЫПО ЭЛЕКТРОБЕЗОПАСНОСТИ ЭЛЕКТРОТЕХНИЧЕСКОГО(ЭЛЕКТРОТЕХНОЛОГИЧЕСКОГО) ПЕРСОНАЛА И УСЛОВИЯ ИХ ПРИСВОЕНИЯ",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101686,
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_right",
              content: "к Правилам по охране труда",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 2,
              isHTML: false,
              paragraphClass: "align_right",
              content: "при эксплуатации электроустановок,",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 3,
              isHTML: false,
              paragraphClass: "align_right",
              content: "утвержденным приказом Минтруда России",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 4,
              isHTML: false,
              paragraphClass: "align_right",
              content: "от 15 декабря 2020 г. N 903н",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 5,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='45.35pt;'><col width='59.55pt;'><col width='56.7pt;'><col width='73.7pt;'><col width='76.55pt;'><col width='73.7pt;'><col width='71.75pt;'><col width='221.1pt;'></colgroup><tbody><tr><td rowspan='3'><p class='align_center no-indent'><div class='info-link'></div><a id='dst101688' data-info-link='true'></a>Группа по электробезопасности</p></td><td colspan='6'><p class='align_center no-indent'><a id='dst101689'></a>Минимальный стаж работы в электроустановках, мес.</p></td><td rowspan='3'><p class='align_center no-indent'><div class='info-link'></div><a id='dst101690' data-info-link='true'></a>Требования к персоналу</p></td></tr><tr><td colspan='4'><p class='align_center no-indent'><a id='dst101691'></a>персонал организаций, имеющий</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101692'></a>практиканты</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101693'></a>основное общее образование</p></td><td><p class='align_center no-indent'><a id='dst101694'></a>среднее полное образование</p></td><td><p class='align_center no-indent'><a id='dst101695'></a>начальное профессиональное и высшее профессиональное (техническое) образование</p></td><td><p class='align_center no-indent'><a id='dst101696'></a>высшее профессиональное (техническое) образование в области электроэнергетики</p></td><td><p class='align_center no-indent'><a id='dst101697'></a>начальных профессиональных учебных заведений</p></td><td><p class='align_center no-indent'><a id='dst101698'></a>высших учебных заведений, техникумов и колледжей</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101699'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101700'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101701'></a>3</p></td><td><p class='align_center no-indent'><a id='dst101702'></a>4</p></td><td><p class='align_center no-indent'><a id='dst101703'></a>5</p></td><td><p class='align_center no-indent'><a id='dst101704'></a>6</p></td><td><p class='align_center no-indent'><a id='dst101705'></a>7</p></td><td><p class='align_center no-indent'><a id='dst101706'></a>8</p></td></tr><tr><td><p class='align_center no-indent'><div class='info-link'></div><a id='dst101707' data-info-link='true'></a>II</p></td><td colspan='4'><p class='align_center no-indent'><a id='dst101708'></a>Не требуется</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101709'></a>Не требуется</p></td><td><p class='align_left no-indent'><a id='dst101710'></a>1. Элементарные технические знания об электроустановке и ее оборудовании.</p><p class='align_left no-indent'><a id='dst101711'></a>2. Отчетливое представление об опасности электрического тока, опасности приближения к токоведущим частям.</p><p class='align_left no-indent'><a id='dst101712'></a>3. Знание основных мер предосторожности при работах в электроустановках.</p><p class='align_left no-indent'><a id='dst101713'></a>4. Практические навыки оказания первой помощи пострадавшим.</p><p class='align_left no-indent'><div class='info-link'></div><a id='dst101714' data-info-link='true'></a>5. Работники с основным общим или со средним полным образованием должны пройти обучение в образовательных организациях с целью получения знаний и навыков, указанных для данной группы, в объеме не менее 72 часов.</p></td></tr><tr><td><p class='align_center no-indent'><div class='info-link'></div><a id='dst101715' data-info-link='true'></a>III</p></td><td><p class='align_center no-indent'><a id='dst101716'></a>3</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101717'></a>2</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101718'></a>2</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101719'></a>1</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101720'></a>6</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101721'></a>3</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_left no-indent'><a id='dst101722'></a>1. Элементарные познания в общей электротехнике.</p><p class='align_left no-indent'><a id='dst101723'></a>2. Знание электроустановки и порядка ее технического обслуживания.</p><p class='align_left no-indent'><a id='dst101724'></a>3. Знание общих правил охраны труда, в том числе правил допуска к работе, правил пользования и испытаний средств защиты и специальных требований, касающихся выполняемой работы.</p><p class='align_left no-indent'><a id='dst101725'></a>4. Умение обеспечить безопасное ведение работы и вести надзор за работающими в электроустановках.</p><p class='align_left no-indent'><a id='dst101726'></a>5. Знание правил (инструкций) по освобождению пострадавшего от действия электрического тока, оказания первой помощи пострадавшим на производстве и умение практически ее оказывать.</p></td></tr><tr><td><p class='align_center no-indent'><div class='info-link'></div><a id='dst101727' data-info-link='true'></a>IV</p></td><td><p class='align_center no-indent'><a id='dst101728'></a>6</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101729'></a>3</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101730'></a>3</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101731'></a>2</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101732'></a>-</p></td><td><p class='align_center no-indent'><a id='dst101733'></a>-</p></td><td><p class='align_left no-indent'><a id='dst101734'></a>1. Знание электротехники в объеме среднего профессионального образования.</p><p class='align_left no-indent'><a id='dst101735'></a>2. Полное представление об опасности при работах в электроустановках.</p><p class='align_left no-indent'><a id='dst101736'></a>3. Знание Правил, правил технической эксплуатации электрооборудования, правил (инструкций) пользования и испытаний средств защиты, устройства электроустановок и пожарной безопасности в объеме занимаемой должности.</p><p class='align_left no-indent'><a id='dst101737'></a>4. Знание схем электроустановок и оборудования обслуживаемого участка, знание технических мероприятий, обеспечивающих безопасность работ.</p><p class='align_left no-indent'><a id='dst101738'></a>5. Умение проводить инструктаж, организовывать безопасное проведение работ, осуществлять надзор за членами бригады.</p><p class='align_left no-indent'><a id='dst101739'></a>6. Знание правил (инструкций) по освобождению пострадавшего от действия электрического тока, оказания первой помощи и умение практически оказывать ее пострадавшему.</p><p class='align_left no-indent'><a id='dst101740'></a>7. Умение обучать персонал правилам охраны труда, практическим приемам оказания первой помощи пострадавшим на производстве и умение практически ее оказывать.</p></td></tr><tr><td><p class='align_center no-indent'><div class='info-link'></div><a id='dst101741' data-info-link='true'></a>V</p></td><td><p class='align_center no-indent'><a id='dst101742'></a>24 в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101743'></a>12</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101744'></a>6</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101745'></a>3</p><p class='align_center no-indent'>в предыдущей группе</p></td><td><p class='align_center no-indent'><a id='dst101746'></a>-</p></td><td><p class='align_center no-indent'><a id='dst101747'></a>-</p></td><td><p class='align_left no-indent'><a id='dst101748'></a>1. Знание схем электроустановок, компоновки оборудования технологических процессов производства.</p><p class='align_left no-indent'><a id='dst101749'></a>2. Знание настоящих Правил, правил (инструкций) пользования и испытаний средств защиты, четкое представление о том, чем вызвано то или иное требование.</p><p class='align_left no-indent'><a id='dst101750'></a>3. Знание правил технической эксплуатации, правил устройства электроустановок и пожарной безопасности в объеме занимаемой должности.</p><p class='align_left no-indent'><a id='dst101751'></a>4. Умение организовать безопасное проведение работ и осуществлять непосредственное руководство работами в электроустановках любого напряжения.</p><p class='align_left no-indent'><a id='dst101752'></a>5. Умение четко обозначать и излагать требования о мерах безопасности при проведении инструктажа работников.</p><p class='align_left no-indent'><a id='dst101753'></a>6. Умение обучать персонал правилам охраны труда, практическим приемам оказания первой помощи пострадавшим на производстве и умение практически ее оказывать.</p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 57,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "О ПРОВЕРКЕ ЗНАНИЙ ПРАВИЛ РАБОТЫ В ЭЛЕКТРОУСТАНОВКАХ",
              chapterID: 0),
        ]),
    Chapter(id: 58, name: "Первая страница", num: "-", paragraphs: [
      Paragraph(
          id: 101757,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "<table style=''><colgroup><col width='246.6pt;'><col width='65.15pt;'><col width='31.15pt;'><col width='76.5pt;'><col width='17pt;'><col width='17pt;'></colgroup><tbody><tr><td colspan='3'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_right no-indent'><a id='dst101758'></a>УДОСТОВЕРЕНИЕ N ___</p></td><td colspan='2'><p class='align_left no-indent'></p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst101759'></a>Фото работника</p></td><td colspan='2' rowspan='2'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101760'></a>М.П.</p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101761'></a>(организация)</p></td><td colspan='2'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td colspan='2'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101762'></a>(структурное подразделение)</p></td><td colspan='2'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'><a id='dst101763'></a>Дата выдачи '__' ______ 20__ г.</p></td><td colspan='2'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td></tr><tr><td colspan='2'><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_center no-indent'><a id='dst101764'></a>___________________</p><p class='align_center no-indent'>(подпись работника)</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td colspan='6'><p class='no-indent'><a id='dst101765'></a>Без записей результатов проверки знаний недействительно.</p><p class='no-indent'>Во время выполнения служебных обязанностей работник должен иметь удостоверение при себе.</p></td></tr></tbody></table>",
          chapterID: 0),
    ]),
    Chapter(id: 59, name: "Вторая страница", num: "-", paragraphs: [
      Paragraph(
          id: 101766,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "<table style=''><colgroup><col width='87.85pt;'><col width='133.25pt;'><col width='93.55pt;'><col width='138.9pt;'></colgroup><tbody><tr><td colspan='4'><p class='align_center no-indent'><a id='dst101767'></a>___________________________________________________________________</p><p class='align_center no-indent'>(фамилия, имя, отчество (при наличии)</p><p class='align_center no-indent'>___________________________________________________________________</p><p class='align_center no-indent'>(должность)</p></td></tr><tr><td colspan='4'><p class='align_left no-indent'><a id='dst101768'></a>Допущен в качестве _________________________________________________________</p><p class='align_left no-indent'><a id='dst101769'></a>__________________________________________________________________________</p><p class='align_left no-indent'><a id='dst101770'></a>к работам в электроустановках напряжением __________________________________</p></td></tr><tr><td colspan='4'><p class='align_left no-indent'><a id='dst101771'></a>М.П.</p></td></tr><tr><td colspan='4'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'><a id='dst101772'></a>Работодатель</p></td><td><p class='align_center no-indent'><a id='dst101773'></a>____________________</p><p class='align_center no-indent'>(ответственный за электрохозяйство)</p></td><td><p class='align_center no-indent'><a id='dst101774'></a>_____________</p><p class='align_center no-indent'>(подпись)</p></td><td><p class='align_center no-indent'><a id='dst101775'></a>____________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p></td></tr></tbody></table>",
          chapterID: 0),
    ]),
    Chapter(
        id: 60,
        name:
            "Третья страница. Результаты проверки знаний нормативных документов",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101776,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='53.85pt;'><col width='65.2pt;'><col width='116.2pt;'><col width='51pt;'><col width='73.7pt;'><col width='93.55pt;'></colgroup><tbody><tr><td colspan='6'><p class='align_center no-indent'><a id='dst101777'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101778'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101779'></a>Причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101780'></a>Группа по электробезопасности</p></td><td><p class='align_center no-indent'><a id='dst101781'></a>Общая оценка</p></td><td><p class='align_center no-indent'><a id='dst101782'></a>Дата следующей проверки</p></td><td><p class='align_center no-indent'><a id='dst101783'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 61,
        name:
            "Четвертая страница. Результаты проверки знаний нормативных документов по устройству и технической эксплуатации",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101784,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='59.55pt;'><col width='104.9pt;'><col width='65.2pt;'><col width='99.2pt;'><col width='124.7pt;'></colgroup><tbody><tr><td colspan='5'><p class='align_center no-indent'><a id='dst101785'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ ПО УСТРОЙСТВУ И ТЕХНИЧЕСКОЙ ЭКСПЛУАТАЦИИ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101786'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101787'></a>Причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101788'></a>Оценка</p></td><td><p class='align_center no-indent'><a id='dst101789'></a>Дата следующей проверки</p></td><td><p class='align_center no-indent'><a id='dst101790'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 62,
        name:
            "Пятая страница. Результаты проверки знаний нормативных документов по охране труда",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101791,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='53.85pt;'><col width='65.2pt;'><col width='116.2pt;'><col width='51pt;'><col width='73.7pt;'><col width='93.55pt;'></colgroup><tbody><tr><td colspan='6'><p class='align_center no-indent'><div class='info-link'></div><a id='dst101792' data-info-link='true'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ ПО ОХРАНЕ ТРУДА</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101793'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101794'></a>Причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101795'></a>Группа по электробезопасности</p></td><td><p class='align_center no-indent'><a id='dst101796'></a>Оценка</p></td><td><p class='align_center no-indent'><a id='dst101797'></a>Дата следующей проверки</p></td><td><p class='align_center no-indent'><a id='dst101798'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 63,
        name:
            "Шестая страница. Результаты проверки знаний нормативных документов по пожарной безопасности",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101799,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='53.85pt;'><col width='93.55pt;'><col width='79.35pt;'><col width='102.05pt;'><col width='124.7pt;'></colgroup><tbody><tr><td colspan='5'><p class='align_center no-indent'><a id='dst101800'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ ПО ПОЖАРНОЙ БЕЗОПАСНОСТИ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101801'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101802'></a>Причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101803'></a>Оценка</p></td><td><p class='align_center no-indent'><a id='dst101804'></a>Дата следующей проверки</p></td><td><p class='align_center no-indent'><a id='dst101805'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 64,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='68.2pt;'><col width='133.25pt;'><col width='130.4pt;'><col width='121.9pt;'></colgroup><tbody><tr><td colspan='4'><p class='align_center no-indent'><a id='dst101807'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ ПО ПРОМЫШЛЕННОЙ БЕЗОПАСНОСТИ И ДРУГИХ СПЕЦИАЛЬНЫХ ПРАВИЛ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101808'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101809'></a>Наименование Правил</p></td><td><p class='align_center no-indent'><a id='dst101810'></a>Решение комиссии</p></td><td><p class='align_center no-indent'><a id='dst101811'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 65,
        name:
            "Восьмая страница. Свидетельство на право проведения специальных работ",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 101812,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='67.9pt;'><col width='184.25pt;'><col width='201.25pt;'></colgroup><tbody><tr><td colspan='3'><p class='align_center no-indent'><div class='info-link'></div><a id='dst101813' data-info-link='true'></a>СВИДЕТЕЛЬСТВО НА ПРАВО ПРОВЕДЕНИЯ СПЕЦИАЛЬНЫХ РАБОТ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101814'></a>Дата</p></td><td><p class='align_center no-indent'><a id='dst101815'></a>Наименование работ</p></td><td><p class='align_center no-indent'><a id='dst101816'></a>Подпись председателя комиссии</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 66,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "О ПРОВЕРКЕ ЗНАНИЙ ПРАВИЛ РАБОТНИКАМИ,",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 8,
              isHTML: false,
              paragraphClass: "align_center",
              content: "КОНТРОЛИРУЮЩИМИ ЭЛЕКТРОУСТАНОВКИ",
              chapterID: 0),
        ]),
    Chapter(id: 67, name: "Первая страница", num: "-", paragraphs: [
      Paragraph(
          id: 101820,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "<table style=''><colgroup><col width='453.55pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101821'></a>УДОСТОВЕРЕНИЕ</p><p class='align_center no-indent'>о проверке знаний правил работы в электроустановках</p></td></tr></tbody></table>",
          chapterID: 0),
    ]),
    Chapter(id: 68, name: "Вторая страница", num: "-", paragraphs: [
      Paragraph(
          id: 101822,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "<table style=''><colgroup><col width='181.4pt;'><col width='65.2pt;'><col width='171.5pt;'><col width='18.4pt;'><col width='17pt;'></colgroup><tbody><tr><td colspan='3'><p class='align_left no-indent'><a id='dst101823'></a>Министерство (ведомство) _____________________________________________</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='3'><p class='align_left no-indent'><a id='dst101824'></a>Организация _________________________________________________________</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='3'><p class='align_center no-indent'><a id='dst101825'></a>УДОСТОВЕРЕНИЕ N ___</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='3' rowspan='2'><p class='align_left no-indent'><a id='dst101826'></a>____________________________________________________________________</p><p class='align_center no-indent'>(фамилия, имя, отчество (при наличии)</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='3'><p class='align_left no-indent'><a id='dst101827'></a>Должность __________________________________________________________</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='3'><p class='align_left no-indent'><a id='dst101828'></a>Допущен к инспектированию электроустановок напряжением _____________</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='2'><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td colspan='2'><p class='align_left no-indent'><a id='dst101829'></a>М.П.</p></td><td><p class='align_left no-indent'><a id='dst101830'></a>Дата выдачи '__' _____ 20__ г.</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td rowspan='2'><p class='align_left no-indent'><a id='dst101831'></a>Работодатель (главный инженер)</p></td><td colspan='3'><p class='align_left no-indent'><a id='dst101832'></a>_________________________________________</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td colspan='3'><p class='align_center no-indent'><a id='dst101833'></a>(подпись, фамилия, инициалы)</p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
          chapterID: 0),
    ]),
    Chapter(
        id: 69,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='53.85pt;'><col width='65.2pt;'><col width='116.2pt;'><col width='51pt;'><col width='73.7pt;'><col width='93.55pt;'></colgroup><tbody><tr><td colspan='6'><p class='align_center no-indent'><a id='dst101835'></a>РЕЗУЛЬТАТЫ ПРОВЕРКИ ЗНАНИЙ НОРМАТИВНЫХ ДОКУМЕНТОВ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101836'></a>Дата проверки</p></td><td><p class='align_center no-indent'><a id='dst101837'></a>Причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101838'></a>Группа по электробезопасности</p></td><td><p class='align_center no-indent'><a id='dst101839'></a>Общая оценка</p></td><td><p class='align_center no-indent'><a id='dst101840'></a>Дата следующей проверки</p></td><td><p class='align_center no-indent'><a id='dst101841'></a>Подпись председателя комиссии по проверке знаний</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(id: 70, name: "Четвертая страница", num: "-", paragraphs: [
      Paragraph(
          id: 101842,
          num: 0,
          isHTML: false,
      ...
      Paragraph(
          ...
          paragraphClass: "-",
          content:
              "<table style=''><colgroup><col width='453.55pt;'></colgroup><tbody><tr><td><p class='no-indent'><a id='dst101843'></a>Без записи проверки знаний удостоверение недействительно.</p><p class='align_left no-indent'>Во время исполнения служебных обязанностей работник должен иметь удостоверения при себе.</p></td></tr></tbody></table>",
          chapterID: 0),
    ]),
    Chapter(
        id: 71,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'>                               ПРОТОКОЛ N ___</p><p class='no-indent'>             ПРОВЕРКИ ЗНАНИЙ ПРАВИЛ РАБОТЫ В ЭЛЕКТРОУСТАНОВКАХ</p><p class='no-indent'></p><p class='no-indent'><a id='dst101847' href='undefined'></a>Дата проверки _____________________________________________________________</p><p class='no-indent'><a id='dst101848' href='undefined'></a>Причина проверки __________________________________________________________</p><p class='no-indent'><a id='dst101849' href='undefined'></a>Комиссия __________________________________________________________________</p><p class='no-indent'>                               (наименование комиссии)</p><p class='no-indent'><a id='dst101850' href='undefined'></a>в составе:</p><p class='no-indent'><a id='dst101851' href='undefined'></a>председатель комиссии _____________________________________________________</p><p class='no-indent'>                                  (должность, фамилия и инициалы)</p><p class='no-indent'><a id='dst101852' href='undefined'></a>члены комиссии (должность, фамилия и инициалы):</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>провела   проверку   знаний  нормативных  документов,  инструкций  (указать</p><p class='no-indent'>наименования).</p><p class='no-indent'></p><p class='no-indent'><a id='dst101853' href='undefined'></a>    Проверяемый:</p><p class='no-indent'></p><p class='no-indent'><a id='dst101854' href='undefined'></a>фамилия, имя, отчество (при наличии) ______________________________________</p><p class='no-indent'><a id='dst101855' href='undefined'></a>место работы ______________________________________________________________</p><p class='no-indent'><a id='dst101856' href='undefined'></a>должность _________________________________________________________________</p><p class='no-indent'><a id='dst101857' href='undefined'></a>дата предыдущей проверки __________________________________________________</p><p class='no-indent'><a id='dst101858' href='undefined'></a>оценка, группа по электробезопасности _____________________________________</p><p class='no-indent'></p><p class='no-indent'><a id='dst101859' href='undefined'></a>    Результаты проверки знаний:</p><p class='no-indent'></p><p class='no-indent'><a id='dst101860' href='undefined'></a>по устройству электроустановок и технической эксплуатации _________________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'><a id='dst101861' href='undefined'></a>по охране труда ___________________________________________________________</p><p class='no-indent'><a id='dst101862' href='undefined'></a>по пожарной безопасности __________________________________________________</p><p class='no-indent'><a id='dst101863' href='undefined'></a>других правил и инструкций органов государственного надзора _______________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>                           (наименование правил)</p><p class='no-indent'></p><p class='no-indent'><a id='dst101864' href='undefined'></a>    Заключение комиссии:</p><p class='no-indent'></p><p class='no-indent'><a id='dst101865' href='undefined'></a>общая оценка ______________________________________________________________</p><p class='no-indent'><a id='dst101866' href='undefined'></a>группа по электробезопасности _____________________________________________</p><p class='no-indent'><a id='dst101867' href='undefined'></a>продолжительность    дублирования    (указывается    для    диспетчерского,</p><p class='no-indent'>оперативного и оперативно-ремонтного персонала) ___________________________</p><p class='no-indent'><a id='dst101868' href='undefined'></a>допущен   в   качестве   (указывается   категория  персонала:  оперативный,</p><p class='no-indent'>оперативно-ремонтный, диспетчерский персонал) _____________________________</p><p class='no-indent'><a id='dst101869' href='undefined'></a>к работам в электроустановках напряжением (указывается класс напряжения (до</p><p class='no-indent'>1000  В,  до и свыше 1000 В) для работников, допущенных к непосредственному</p><p class='no-indent'>выполнению работ в электроустановках) _____________________________________</p><p class='no-indent'><a id='dst101870' href='undefined'></a>дата следующей проверки ___________________________________________________</p><p class='no-indent'></p><p class='no-indent'>    Подписи:</p><p class='no-indent'></p><p class='no-indent'>председатель комиссии _____________________________________________________</p><p class='no-indent'>                                 (подпись, фамилия и инициалы)</p><p class='no-indent'></p><p class='no-indent'>члены комиссии</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>                       (подпись, фамилия и инициалы)</p><p class='no-indent'></p><p class='no-indent'>представитель(ли) органов государственного надзора и контроля (подписывает,</p><p class='no-indent'>если участвует в работе комиссии)</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>                       (подпись, фамилия и инициалы)</p><p class='no-indent'></p><p class='no-indent'>С заключением комиссии ознакомлен _________________________________________</p><p class='no-indent'>                                        (подпись, фамилия и инициалы)</p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 72,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "ДЛЯ ОРГАНИЗАЦИЙ ЭЛЕКТРОЭНЕРГЕТИКИ",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 9,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='17pt;'><col width='158.75pt;'><col width='96.4pt;'><col width='162.15pt;'><col width='17pt;'></colgroup><tbody><tr><td colspan='2'><p><a id='dst101874'></a>Формат A4</p></td><td><p class='align_center no-indent'><a id='dst101875'></a>Заглавный лист</p></td><td colspan='2'><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td colspan='3'><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'><a id='dst101876'></a>(наименование организации)</p></td><td><p class='align_left no-indent'></p></td><td><p class='align_right no-indent'><a id='dst101877'></a>(структурное подразделение)</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td colspan='5'><p class='align_center no-indent'><div class='info-link'></div><a id='dst101878' data-info-link='true'></a>ЖУРНАЛ</p><p class='align_center no-indent'>УЧЕТА ПРОВЕРКИ ЗНАНИЙ ПРАВИЛ</p><p class='align_center no-indent'>РАБОТЫ В ЭЛЕКТРОУСТАНОВКАХ</p></td></tr><tr><td colspan='5'><p class='align_left no-indent'><a id='dst101879'></a>Начат '__' __________ 20__ г.</p><p class='align_left no-indent'>Окончен '__' __________ 20__ г..</p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101880,
              num: 10,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='27.2pt;'><col width='86.4pt;'><col width='104.65pt;'><col width='36.95pt;'><col width='51.9pt;'><col width='143.45pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101881'></a>N п/п</p></td><td><p class='align_center no-indent'><a id='dst101882'></a>Фамилия, имя, отчество (при наличии), должность (профессия)</p></td><td><p class='align_center no-indent'><a id='dst101883'></a>Номер протокола, фамилия председателя комиссии по проверке знаний</p></td><td><p class='align_center no-indent'><a id='dst101884'></a>Дата</p></td><td><p class='align_center no-indent'><a id='dst101885'></a>Общая оценка</p></td><td><p class='align_center no-indent'><a id='dst101886'></a>Группа по электробезопасности</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101887'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101888'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101889'></a>3</p></td><td><p class='align_center no-indent'><a id='dst101890'></a>4</p></td><td><p class='align_center no-indent'><a id='dst101891'></a>5</p></td><td><p class='align_center no-indent'><a id='dst101892'></a>6</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 73,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='25.5pt;'><col width='76.55pt;'><col width='76.55pt;'><col width='59.55pt;'><col width='76.55pt;'><col width='73.7pt;'><col width='65.2pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101896'></a>N п/п</p></td><td><p class='align_center no-indent'><a id='dst101897'></a>Фамилия, имя, отчество (при наличии), занимаемая должность и стаж работы в этой должности</p></td><td><p class='align_center no-indent'><a id='dst101898'></a>Дата предыдущей проверки, оценка знаний и группа по электробезопасности</p></td><td><p class='align_center no-indent'><a id='dst101899'></a>Дата и причина проверки</p></td><td><p class='align_center no-indent'><a id='dst101900'></a>Общая оценка знаний, группа по электробезопасности и заключение комиссии по проверке знаний</p></td><td><p class='align_center no-indent'><a id='dst101901'></a>Подпись проверяемого работника</p></td><td><p class='align_center no-indent'><a id='dst101902'></a>Дата следующей проверки</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 9,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='127.55pt;'><col width='258.55pt;'><col width='67.45pt;'></colgroup><tbody><tr><td><p class='no-indent'><a id='dst101903'></a>Председатель комиссии</p><p class='no-indent'>по проверке знаний</p></td><td><p class='align_center no-indent'><a id='dst101904'></a>________________________________________</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_center no-indent'><a id='dst101905'></a>(должность, подпись, фамилия, инициалы)</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='no-indent'><a id='dst101906'></a>Члены комиссии</p><p class='no-indent'>по проверке знаний</p></td><td><p class='align_center no-indent'><a id='dst101907'></a>________________________________________</p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_center no-indent'><a id='dst101908'></a>(должность, подпись, фамилия, инициалы)</p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 74,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'>                               НАРЯД-ДОПУСК</p><p class='no-indent'>                 ДЛЯ РАБОТЫ В ЭЛЕКТРОУСТАНОВКАХ И УКАЗАНИЯ</p><p class='no-indent'>                             ПО ЕГО ЗАПОЛНЕНИЮ</p><p class='no-indent'></p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 75,
        ...
        paragraphs: [
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'></p><p class='no-indent'>Организация _________________________</p><p class='no-indent'><a id='dst101914' href='undefined'></a>Подразделение _______________________</p><p class='no-indent'></p><p class='no-indent'><a id='dst101915' href='undefined'></a>                       НАРЯД-ДОПУСК N _____________</p><p class='no-indent'>                      для работы в электроустановках</p><p class='no-indent'></p><p class='no-indent'><a id='dst101916' href='undefined'></a>Ответственному руководителю</p><p class='no-indent'><a id='dst101917' href='undefined'></a>работ _____________________________, допускающему _________________________</p><p class='no-indent'>           (фамилия, инициалы,                       (фамилия, инициалы,</p><p class='no-indent'>                группа по                                 группа по</p><p class='no-indent'>          электробезопасности)                      электробезопасности)</p><p class='no-indent'><a id='dst101918' href='undefined'></a>Производителю</p><p class='no-indent'>работ _____________________________, наблюдающему _________________________</p><p class='no-indent'>           (фамилия, инициалы)                       (фамилия, инициалы)</p><p class='no-indent'>                группа по                                 группа по</p><p class='no-indent'>          электробезопасности)                      электробезопасности)</p><p class='no-indent'><a id='dst101919' href='undefined'></a>с членами бригады _________________________________________________________</p><p class='no-indent'>                     (фамилия, инициалы, группа по электробезопасности)</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>            (фамилия, инициалы, группа по электробезопасности)</p><p class='no-indent'><a id='dst101920' href='undefined'></a>поручается ________________________________________________________________</p><p class='no-indent'><a id='dst101921' href='undefined'></a>Работу начать: дата ______________ время ______________</p><p class='no-indent'><a id='dst101922' href='undefined'></a>Работу закончить: дата _______________ время ______________</p><p class='no-indent'></p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 76,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='175.75pt;'><col width='141.75pt;'><col width='136.05pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101924'></a>Наименование электроустановок, в которых нужно провести отключения и установить заземления</p></td><td><p class='align_center no-indent'><a id='dst101925'></a>Что должно быть отключено и где заземлено</p></td><td><p class='align_center no-indent'><a id='dst101926'></a>Что должно быть изолировано (ограждено)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101927'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101928'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101929'></a>3</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 101930,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'>Отдельные указания ________________________________________________________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'><a id='dst101931' href='undefined'></a>Наряд-допуск выдал: дата _____________________ время ______________________</p><p class='no-indent'>Подпись ____________________________ Фамилия, инициалы ____________________</p><p class='no-indent'><a id='dst101932' href='undefined'></a>Наряд-допуск продлил по: дата ________________ время ______________________</p><p class='no-indent'>Подпись ____________________________ Фамилия, инициалы ____________________</p><p class='no-indent'>Дата __________________________ время _____________________________________</p><p class='no-indent'></p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 77,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='94.65pt;'><col width='109.3pt;'><col width='137.35pt;'><col width='106.9pt;'></colgroup><tbody><tr><td colspan='2'><p class='align_left no-indent'><a id='dst101934'></a>Целевой инструктаж провел</p></td><td colspan='2'><p class='no-indent'><a id='dst101935'></a>Целевой инструктаж получил</p></td></tr><tr><td rowspan='2'><p class='no-indent'><a id='dst101936'></a>Работник, выдавший наряд-допуск</p></td><td><p class='align_center no-indent'><a id='dst101937'></a>____________</p><p class='align_center no-indent'>(фамилия, инициалы)</p></td><td rowspan='2'><p class='align_left no-indent'><a id='dst101938'></a>Ответственный руководитель работ (производитель работ, наблюдающий)</p></td><td><p class='align_center no-indent'><a id='dst101939'></a>_____________</p><p class='align_center no-indent'>(фамилия, инициалы)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101940'></a>____________</p><p class='align_center no-indent'>(подпись)</p></td><td><p class='align_center no-indent'><a id='dst101941'></a>____________</p><p class='align_center no-indent'>(подпись)</p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 78,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='200.65pt;'><col width='61.1pt;'><col width='186.45pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101943'></a>Разрешение на подготовку рабочих мест и на допуск к выполнению работ выдал (должность, фамилия или подпись)</p></td><td><p class='align_center no-indent'><a id='dst101944'></a>Дата, время</p></td><td><p class='align_center no-indent'><a id='dst101945'></a>Подпись работника, получившего разрешение на подготовку рабочих мест и на допуск к выполнению работ</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101946'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101947'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101948'></a>3</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 79,
        ...
        paragraphs: [
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'></p><p class='no-indent'>Рабочие места подготовлены. Под напряжением остались: _____________________</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'></p><p class='no-indent'><a id='dst101951' href='undefined'></a>Допускающий _______________________________________________________________</p><p class='no-indent'>                                        (подпись)</p><p class='no-indent'></p><p class='no-indent'><a id='dst101952' href='undefined'></a>Ответственный руководитель работ</p><p class='no-indent'>(производитель работ или наблюдающий) _____________________________________</p><p class='no-indent'>                                                   (подпись)</p><p class='no-indent'></p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 80,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='93.55pt;'><col width='119.05pt;'><col width='116.2pt;'><col width='124.7pt;'></colgroup><tbody><tr><td colspan='2'><p class='align_center no-indent'><a id='dst101954'></a>Целевой инструктаж провел</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101955'></a>Целевой инструктаж получил</p></td></tr><tr><td rowspan='3'><p class='align_center no-indent'><a id='dst101956'></a>Допускающий</p></td><td rowspan='3'><p class='align_center no-indent'><a id='dst101957'></a>_______________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>________________</p><p class='align_center no-indent'>(подпись)</p></td><td><p class='align_center no-indent'><a id='dst101958'></a>Ответственный руководитель работ</p></td><td><p class='align_center no-indent'><a id='dst101959'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>__________________</p><p class='align_center no-indent'>(подпись)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101960'></a>Производитель работ (наблюдающий)</p></td><td><p class='align_center no-indent'><a id='dst101961'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>__________________</p><p class='align_center no-indent'>(подпись)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101962'></a>Члены бригады</p></td><td><p class='align_center no-indent'><a id='dst101963'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>__________________</p><p class='align_center no-indent'>(подпись)</p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 81,
        name: "              Ежедневный допуск к работе и время ее окончания",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 0,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='87.85pt;'><col width='45.35pt;'><col width='48.15pt;'><col width='113.35pt;'><col width='45.35pt;'><col width='113.35pt;'></colgroup><tbody><tr><td colspan='4'><p class='align_center no-indent'><a id='dst101965'></a>Бригада получила целевой инструктаж и допущена на подготовленное рабочее место</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101966'></a>Работа закончена, бригада удалена</p></td></tr><tr><td rowspan='2'><p class='align_center no-indent'><a id='dst101967'></a>наименование рабочего места</p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst101968'></a>дата, время</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101969'></a>подписи (подпись, фамилия, инициалы)</p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst101970'></a>дата, время</p></td><td rowspan='2'><p class='align_center no-indent'><a id='dst101971'></a>подпись производителя работ (наблюдающего) (подпись) (фамилия, инициалы)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101972'></a>допускающего</p></td><td><p class='align_center no-indent'><a id='dst101973'></a>производителя работ (наблюдающего)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101974'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101975'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101976'></a>3</p></td><td><p class='align_center no-indent'><a id='dst101977'></a>4</p></td><td><p class='align_center no-indent'><a id='dst101978'></a>5</p></td><td><p class='align_center no-indent'><a id='dst101979'></a>6</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 82,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='110.45pt;'><col width='115.2pt;'><col width='104.4pt;'><col width='123pt;'></colgroup><tbody><tr><td colspan='2'><p class='align_center no-indent'><a id='dst101981'></a>Целевой инструктаж провел</p></td><td colspan='2'><p class='align_center no-indent'><a id='dst101982'></a>Целевой инструктаж получил</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101983'></a>Ответственный руководитель работ</p></td><td><p class='align_center no-indent'><a id='dst101984'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>__________________</p><p class='align_center no-indent'>(подпись)</p></td><td><p class='align_center no-indent'><a id='dst101985'></a>Производитель работ,</p><p class='align_center no-indent'>Члены бригады</p></td><td><p class='align_center no-indent'><a id='dst101986'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы) __________________</p><p class='align_center no-indent'>(подпись)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101987'></a>Производитель работ (наблюдающий)</p></td><td><p class='align_center no-indent'><a id='dst101988'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы)</p><p class='align_center no-indent'>__________________</p><p class='align_center no-indent'>(подпись)</p></td><td><p class='align_center no-indent'><a id='dst101989'></a>Члены бригады</p></td><td><p class='align_center no-indent'><a id='dst101990'></a>__________________</p><p class='align_center no-indent'>(фамилия, инициалы) __________________</p><p class='align_center no-indent'>(подпись)</p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
    Chapter(
        id: 83,
        name: "                        Изменения в составе бригады",
        num: "-",
        paragraphs: [
          Paragraph(
              id: 0,
          ...
          Paragraph(
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='150.2pt;'><col width='133.2pt;'><col width='79.35pt;'><col width='90.7pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst101992'></a>Введен в состав бригады (фамилия, инициалы, группа)</p></td><td><p class='align_center no-indent'><a id='dst101993'></a>Выведен из состава бригады (фамилия, инициалы, группа)</p></td><td><p class='align_center no-indent'><a id='dst101994'></a>Дата, время (дата, время)</p></td><td><p class='align_center no-indent'><a id='dst101995'></a>Разрешил (подпись) (фамилия, инициалы)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst101996'></a>1</p></td><td><p class='align_center no-indent'><a id='dst101997'></a>2</p></td><td><p class='align_center no-indent'><a id='dst101998'></a>3</p></td><td><p class='align_center no-indent'><a id='dst101999'></a>4</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
          Paragraph(
              id: 102000,
              num: 2,
              ...
              paragraphClass: "-",
              content:
                  "<p class='no-indent'>    Работа  полностью закончена, бригада удалена, заземления, установленные</p><p class='no-indent'>бригадой, сняты, сообщено (кому) __________________________________________</p><p class='no-indent'>                                               (должность)</p><p class='no-indent'>___________________________________________________________________________</p><p class='no-indent'>                            (фамилия, инициалы)</p><p class='no-indent'></p><p class='no-indent'><a id='dst102001' href='undefined'></a>Дата ________________________________ время _______________________________</p><p class='no-indent'></p><p class='no-indent'><a id='dst102002' href='undefined'></a>Производитель работ или наблюдающий _______________________________________</p><p class='no-indent'>                                         (подпись, фамилия, инициалы)</p><p class='no-indent'></p><p class='no-indent'><a id='dst102003' href='undefined'></a>Ответственный руководитель работ __________________________________________</p><p class='no-indent'>                                        (подпись, фамилия, инициалы)</p>",
              chapterID: 0),
        ]),
    Chapter(
        id: 84,
        ...
        paragraphs: [
          ...
          Paragraph(
              ...
              isHTML: false,
              paragraphClass: "align_center",
              content: "УЧЕТА РАБОТ ПО НАРЯДАМ-ДОПУСКАМ И РАСПОРЯЖЕНИЯМ",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 8,
              isHTML: false,
              paragraphClass: "align_center",
              content: "ДЛЯ РАБОТ В ЭЛЕКТРОУСТАНОВКАХ",
              chapterID: 0),
          Paragraph(
              id: 0,
              num: 9,
              ...
              paragraphClass: "-",
              content:
                  "<table style=''><colgroup><col width='59.55pt;'><col width='49.8pt;'><col width='51pt;'><col width='76.55pt;'><col width='68.05pt;'><col width='82.2pt;'><col width='94.8pt;'><col width='65.2pt;'><col width='51pt;'><col width='45.35pt;'></colgroup><tbody><tr><td><p class='align_center no-indent'><a id='dst102007'></a>Номер распоряжения</p></td><td><p class='align_center no-indent'><a id='dst102008'></a>Номер наряда</p></td><td><p class='align_center no-indent'><a id='dst102009'></a>Место и наименование работы</p></td><td><p class='align_center no-indent'><a id='dst102010'></a>Производитель работы, наблюдающий (фамилия, инициалы, группа по электробезопасности)</p></td><td><p class='align_center no-indent'><a id='dst102011'></a>Члены бригады (фамилия, инициалы, группа по электробезопасности)</p></td><td><p class='align_center no-indent'><a id='dst102012'></a>Работник, отдавший распоряжение (фамилия, инициалы, группа по электробезопасности)</p></td><td><p class='align_center no-indent'><a id='dst102013'></a>Технические мероприятия по обеспечению безопасности работ с указанием необходимых отключений, мест установки заземлений</p></td><td><p class='align_center no-indent'><div class='info-link'></div><a id='dst102014' data-info-link='true'></a>Подписи работников, проводивших и получивших целевые инструктажи</p></td><td><p class='align_center no-indent'><a id='dst102015'></a>К работе приступили (дата, время)</p></td><td><p class='align_center no-indent'><a id='dst102016'></a>Работа закончена (дата, время)</p></td></tr><tr><td><p class='align_center no-indent'><a id='dst102017'></a>1</p></td><td><p class='align_center no-indent'><a id='dst102018'></a>2</p></td><td><p class='align_center no-indent'><a id='dst102019'></a>3</p></td><td><p class='align_center no-indent'><a id='dst102020'></a>4</p></td><td><p class='align_center no-indent'><a id='dst102021'></a>5</p></td><td><p class='align_center no-indent'><a id='dst102022'></a>6</p></td><td><p class='align_center no-indent'><a id='dst102023'></a>7</p></td><td><p class='align_center no-indent'><a id='dst102024'></a>8</p></td><td><p class='align_center no-indent'><a id='dst102025'></a>9</p></td><td><p class='align_center no-indent'><a id='dst102026'></a>10</p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr><tr><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td><td><p class='align_left no-indent'></p></td></tr></tbody></table>",
              chapterID: 0),
        ]),
  ];
}
