...
class Regulation {
  ...
  static const String abbreviation = "ПОТЭУ-903н-2020";
  static const List<Chapter> chapters = <Chapter>[
    Chapter(id: 1, name: "Общие положения", num: "I", orderNum: 1, paragraphs: [
      Paragraph(
          id: 100017,
          num: 0,
          isHTML: false,
    ...
    Chapter(
        id: 11,
        name:
            "Охрана труда при выдаче разрешений на подготовку рабочего места и допуск к работе в электроустановках",
        num: "IX",
        orderNum: 11,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 12,
        name:
            "Охрана труда при подготовке рабочего места и первичном допуске бригады к работе в электроустановках по наряду-допуску и распоряжению",
        num: "X",
        orderNum: 12,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 17,
        name:
            "Охрана труда при включении электроустановок после полного окончания работ",
        num: "XV",
        orderNum: 17,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 19,
        name: "Охрана труда при выполнении отключений в электроустановках",
        num: "XVII",
        orderNum: 19,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 23,
        name:
            "Охрана труда при установке заземлений в распределительных устройствах",
        num: "XXI",
        orderNum: 23,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 25,
        name: "Ограждение рабочего места, вывешивание плакатов безопасности",
        num: "XXIII",
        orderNum: 25,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 29,
        name: "Охрана труда при выполнении работ в электролизных установках",
        num: "XXVI",
        orderNum: 29,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 31,
        name: "Охрана труда при выполнении работ на электродвигателях",
        num: "XXVII",
        orderNum: 31,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 32,
        name: "Охрана труда при выполнении работ на коммутационных аппаратах",
        num: "XXVIII",
        orderNum: 32,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 33,
        name:
            "Охрана труда при выполнении работ в комплектных распределительных устройствах",
        num: "XXIX",
        orderNum: 33,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 34,
        name:
            "Охрана труда при выполнении работ на мачтовых (столбовых) трансформаторных подстанциях и комплектных трансформаторных подстанциях",
        num: "XXX",
        orderNum: 34,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 36,
        name:
            "Охрана труда при выполнении работ на измерительных трансформаторах тока",
        num: "XXXII",
        orderNum: 36,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 37,
        name: "Охрана труда при выполнении работ на электрических котлах",
        num: "XXXIII",
        orderNum: 37,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 39,
        name: "Охрана труда при выполнении работ с аккумуляторными батареями",
        num: "XXXV",
        orderNum: 39,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 40,
        name: "Охрана труда при выполнении работ на конденсаторных установках",
        num: "XXXVI",
        orderNum: 40,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 41,
        name: "Охрана труда при выполнении работ на кабельных линиях",
        num: "XXXVII",
        orderNum: 41,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 44,
        name: "Охрана труда при проведении испытаний и измерений",
        num: "XXXIX",
        orderNum: 44,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 45,
        name: "Охрана труда при обмыве и чистке изоляторов под напряжением",
        num: "XL",
        orderNum: 45,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 48,
        name:
            "Охрана труда при выполнении работ в устройствах релейной защиты и электроавтоматики, со средствами измерений и приборами учета электроэнергии, вторичными цепями",
        num: "XLII",
        orderNum: 48,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 49,
        name:
            "Охрана труда при выполнении работ в электрической части устройств тепловой автоматики, теплотехнических измерений и защит",
        num: "XLIII",
        orderNum: 49,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 52,
        name:
            "Охрана труда при выполнении работ в электроустановках с применением автомобилей, подъемных сооружений и механизмов, лестниц",
        num: "XLV",
        orderNum: 52,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 53,
        name: "Охрана труда при организации работ командированного персонала",
        num: "XLVI",
        orderNum: 53,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 54,
        name:
            "Охрана труда при допуске персонала строительно-монтажных организаций к работам в действующих электроустановках и в охранной зоне линий электропередачи",
        num: "XLVII",
        orderNum: 54,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 75,
        name: "Лицевая сторона наряда-допуска",
        num: "",
        orderNum: 75,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 76,
        name: "Мероприятия по подготовке рабочих мест к выполнению работ",
        num: "",
        orderNum: 76,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 77,
        name: "Регистрация целевого инструктажа, проводимого выдающим наряд",
        num: "",
        orderNum: 77,
        paragraphs: [
          Paragraph(
    ...
    Chapter(
        id: 79,
        name: "Оборотная сторона наряда-допуска",
        num: "",
        orderNum: 79,
        paragraphs: [
          Paragraph(
